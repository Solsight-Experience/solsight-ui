...
export function NotificationPanel() {
  ...
  return (
    <div className="w-[380px] bg-[#0d1117] border border-white/10 rounded-xl
      ...
      <div className="flex items-center justify-between px-3.5 py-3 bg-purple-500/[0.06]">
        ...
        {unreadCount > 0 && (
          <button
            ...
            className="text-[11px] text-violet-400 hover:text-violet-300 transition-colors duration-150"
          >
            Mark all as read
          </button>
        )}
