...
export const PortfolioSummaryCard: React.FC<PortfolioSummaryCardProps> = ({ data }) => {
    ...
    return (
        ...
        >
            <div className="bg-gradient-to-br from-violet-500/10 via-transparent to-indigo-500/5 px-4 py-3 border-b border-[var(--border-faint)]">
                ...
                <div className="text-xs text-[var(--text-muted)] mt-0.5">{total_balance_sol.toFixed(4)} SOL</div>
            </div>
