                ...
                <div className="grid grid-cols-2 gap-2">
                    <Button
                        ...
                        className={cn(
                            ...
                            state.mode === "auto" && "!ring-gray-400 dark:ring-white/80",
                    ...
                    <div
                        className={cn("relative flex-grow ring-1 ring-transparent rounded-md", state.mode === "custom" && "!ring-gray-400 dark:ring-white/80")}
                    >
                        <NumbericInput
                            mode="string"
                            decimals={9}
                ...
                {this.options.map((option) => (
                    <Button
                        ...
                        className={cn(
                            ...
                            state.value === option.id && "!bg-gray-300 dark:bg-zinc-700 !text-gray-900 dark:text-white ring-1 !ring-gray-400 dark:ring-white/80"
                        )}
                    >
