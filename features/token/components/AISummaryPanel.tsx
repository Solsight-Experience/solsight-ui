...
export const AISummaryPanel: React.FC<AISummaryPanelProps> = ({ isOpen, onToggle, tokenAddress, tokenName = "Token", options }) => {
        ...
        >
            <div className="border border-gray-700 rounded-lg p-4 bg-gray-900/50 mb-4">
                ...
                <div className="flex items-center justify-between mb-3">
                    ...
                    <button onClick={onToggle} className="text-gray-500 hover:text-gray-300 transition-colors text-sm">
                        ✕
                    </button>
                </div>
                ...
                {isLoading ? (
                    ...
                    <AISummaryContent content={summary.summary} onRegenerate={() => setSummary(null)} />
                ) : null}
            </div>
        </div>
    );
