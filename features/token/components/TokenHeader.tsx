      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex flex-col">
            <div className="flex items-center gap-3">
              ...
              >
                <Star
                  className={`w-5 h-5 ${
                    isTokenFavorite ? 'fill-yellow-500 text-yellow-500' : 'text-gray-400'
                  }`}
                />
              </button>
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className="px-4 py-2 rounded-lg border border-gray-600 hover:border-gray-500 flex items-center gap-2"
          >
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="px-3 py-1 rounded-full bg-purple-500/20 text-purple-500 text-sm font-semibold">
              Solana Mainnet
            </span>
          </div>
        </div>
