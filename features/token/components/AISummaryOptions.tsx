...
const optionsList = [{ key: "forceRefresh" as const, label: "Force Refresh" }];

export const AISummaryOptions: React.FC<AISummaryOptionsProps> = ({ options, onOptionsChange }) => {
    ...
    return (
        <div className="flex flex-wrap items-center gap-1.5 p-2 bg-gray-900/50 rounded-lg border border-gray-700">
            ...
            <button onClick={resetToDefaults} className="px-2 py-1 rounded text-xs text-gray-500 hover:text-gray-400 hover:bg-gray-800 transition-colors">
                Reset
            </button>
        </div>
    );
