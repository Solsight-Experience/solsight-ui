...
export const WalletPnlPanel: React.FC<WalletPnlPanelProps> = ({
  holder,
  tokenSymbol = 'TOKEN',
  open,
  onOpenChange,
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  ...
                  <p className={`text-sm font-semibold ${(holder.unrealized_pnl || 0) >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                    {(holder.unrealized_pnl || 0) >= 0 ? '+' : ''}{formatNumber(holder.unrealized_pnl || 0)}
                  </p>
                </div>
                <div>
                  ...
                  <p className={`text-sm font-semibold ${(holder.realized_pnl || 0) >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                    {(holder.realized_pnl || 0) >= 0 ? '+' : ''}{formatNumber(holder.realized_pnl || 0)}
                  </p>
                </div>
              </div>
            </div>
