...
export const QuickBuyInput = memo<QuickBuyInputProps>(function QuickBuyInput({
    value,
    onChange,
    currency = 'SOL',
    currencyIcon = 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_Tq97-Pbo95DdBUs0rEHGDkQ4eBkl8gW3WA&s',
}) {
    ...
    return (
        <div className="flex items-center border-[1.25] border-brand-200 rounded-full overflow-hidden px-4 py-0.5 gap-7">
            <Label
                htmlFor="input--quickBuy"
                className="w-auto text-dark-default-hover"
            >
                Quick Buy
            </Label>
            <Input
