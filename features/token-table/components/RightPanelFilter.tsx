 ...
 */
type AllowedFilterComponent = ReactElement<typeof TimeFilters> | ReactElement<typeof QuickBuyInput> | ReactElement<Record<string, unknown>>; // For custom filter components like SortPanel, CategorySearch, etc.
 ...
 */
export const RightPanelFilter = memo<RightPanelFilterProps>(function RightPanelFilter({ children }) {
    return <div className="flex items-center gap-[18px]">{children}</div>;
});
