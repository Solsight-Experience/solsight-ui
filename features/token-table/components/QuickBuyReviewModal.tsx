...
export function QuickBuyReviewModal({
  open,
  onOpenChange,
  token,
  amountSol,
}: QuickBuyReviewModalProps) {
          ...
          <div className="space-y-4 text-sm">
            ...
            <div className="space-y-2 rounded-lg border border-border p-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span>
                  {quote?.priceImpactPct == null ? '--' : `${(quote.priceImpactPct * 100).toFixed(2)}%`}
                </span>
              </div>
              <div className="flex items-center justify-between">
                <span>Route</span>
            ...
            {signature && (
              <div className="text-green-500 text-xs">Swap submitted: {signature.slice(0, 4)}...{signature.slice(-4)}</div>
            )}
          </div>
        ) : (
