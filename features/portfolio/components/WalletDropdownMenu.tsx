    ...
    <>
      <DropdownMenu open={open} onOpenChange={setOpen}>
        <DropdownMenuTrigger asChild>
          <Button variant={"link"}><EllipsisVertical className="size-6 text-purple-500" /></Button>
        </DropdownMenuTrigger>
      ...
      <Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
        <DialogContent className="border-gray-600">
          ...
          <div className="py-4">
            <div className="text-sm text-gray-400 font-mono bg-gray-800 p-3 rounded-md break-all">
              {walletAddress}
            </div>
          </div>
          <DialogFooter>
