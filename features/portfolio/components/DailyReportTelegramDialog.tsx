...
} from "@/features/wallet-tracker/hooks/useTelegramSubscription";
...
interface DailyReportTelegramDialogProps {
    open: boolean;
    onOpenChange: (open: boolean) => void;
}

export function DailyReportTelegramDialog({ open, onOpenChange }: DailyReportTelegramDialogProps) {
    ...
    return (
        <div className="flex flex-col gap-5">
            <p className="text-[12px] text-white/50 leading-relaxed">
                Connect your Telegram account to receive your daily portfolio report directly in your Telegram chat.
            </p>
            <button
                onClick={onConnect}
                disabled={connecting}
...
function VerifiedState({ verifiedAt, onDisconnect, disconnecting }: { verifiedAt: string; onDisconnect: () => void; disconnecting: boolean }) {
    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            <p className="text-[12px] text-white/40 text-center">Your daily portfolio report will be sent to your Telegram chat.</p>
