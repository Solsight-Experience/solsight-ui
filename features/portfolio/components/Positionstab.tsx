                ...
                {positionsData.positions.map((position) => (
                    <tr key={position.token.address} className="border-b border-gray-700 hover:bg-gray-800/50 transition-colors group">
                        <td className="py-3">
                            ...
                            >
                                <img src={position.token.logo_uri} alt={position.token.symbol} className="w-8 h-8 rounded-full" />
                                <div>
                        ...
                        <td className="py-3 font-mono">{formatBalance(position.balance, position.token.symbol)}</td>
                        <td className="py-3">
    ...
    return (
        <div className="flex flex-col gap-2">
            {walletsData.wallets.map((wallet) => {
                ...
                return (
                    <div key={wallet.address} className="border border-gray-600 p-4 rounded-lg flex flex-col gap-4">
                        <div className="flex justify-between items-center">
                            <div className="flex gap-3 items-center flex-1">
                                <img src={wallet.icon} alt={wallet.name} className="h-8 w-8 rounded-lg object-contain" />
                            ...
                            <div className="flex gap-4 items-center">
                                ...
                                <button onClick={() => toggleWalletCollapse(wallet.address)} className="hover:bg-gray-700 p-1 rounded transition-colors">
