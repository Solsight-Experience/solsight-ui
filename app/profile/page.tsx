...
import { Calendar, Copy, DollarSign, Star, TrendingUp } from "lucide-react";
        ...
        <div>
            <div className="flex items-center gap-10 border-b pl-60  border-gray-600 py-4">
                <div className="flex flex-col w-fit gap-2">
                    <Image src={MockUser.avatar_url} alt="User avatar" width={80} height={80} className="h-20 w-20 rounded-full" />
                    {MockUser.is_verified ? (
                        <div className="text-green-500 border text-center border-green-500  p-1 rounded-full">Verified</div>
                    ) : (
                        <div className="text-red-500 border text-center border-red-500  p-1 rounded-full">Not verified</div>
                    )}
                </div>
                <div className="flex flex-col gap-3">
                    <div className="text-gray-300 text-lg">{MockUser.username}</div>
                    <div className="flex items-center gap-2">
                        <div className="border border-gray-600 px-2 py-1 rounded-full">{defaultWallet?.address}</div>
                        <Copy className="size-6 text-gray-400" />
                    </div>
                    <div className="flex gap-3">
                        <Button>
                            <Image src="/x_icon.png" alt="X" width={24} height={24} className="h-6 w-6" />
                            X.com
                        </Button>
                        <Button>
                            <Image src="/github_icon.png" alt="Github" width={24} height={24} className="h-6 w-6" />
                            Github
                        </Button>
                        <Button>
                            <Image src="/internet_icon.png" alt="Website" width={24} height={24} className="h-6 w-6" />
                            Website
                        </Button>
                    </div>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-4 py-8">
                    <div className="grid grid-cols-4 gap-6">
                        ...
                        <div className="border border-gray-600 rounded-xl p-6">
                            ...
                            <div className="text-3xl font-bold mb-3">{MockStats.total_transactions.toLocaleString()}</div>
                        ...
                        <div className="border border-gray-600 rounded-xl p-6">
                            ...
                            <div className="text-3xl font-bold mb-3">{(MockStats.total_volume_usd / 1000).toFixed(1)}K$</div>
                            <div className="flex items-center gap-2 text-purple-500 text-sm">
                                <DollarSign className="w-4 h-4" />
                                <span>USD</span>
                            </div>
            ...
            <div className="flex justify-center flex-col items-center w-full">
                ...
                <div className="mt-8 border border-gray-600 rounded-xl p-6 w-7xl">
                    ...
                    <div className="space-y-4">
                        {MockWallet.wallets.slice(0, 3).map((wallet, index) => (
                            <div key={wallet.address} className="bg-gray-800 border border-gray-700 rounded-lg p-4 flex items-center justify-between">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="flex flex-col">
                                        <div className="flex items-center gap-2">
                                            <span className="font-medium">{index === 0 ? "Main Wallet" : index === 1 ? "Second Wallet" : "Third Wallet"}</span>
                                            {wallet.is_default && (
                                        ...
                                        <div className="flex items-center gap-2 mt-1">
                                            <code className="text-sm text-gray-400 bg-gray-900 px-3 py-1 rounded border border-gray-700">{wallet.address}</code>
                ...
                <div className="mt-8 border border-gray-600 rounded-xl w-7xl p-6 mb-8">
                    ...
                    <div className="mt-8 pt-6 border-t border-gray-800">
                        <Button variant="outline" className="border-purple-600 text-purple-400 hover:bg-purple-600 hover:text-white flex items-center gap-2">
