        ...
        ha ||
            ...
            (function (Et, zt) {
                (function (C, De) {
                    ...
                    function le(e, t) {
                        for (var n = e.split(" "), r = 0; r < n.length; r++) n[r] && !H(n[r]).test(t) && (t += " " + n[r]);
                        return t;
                    }
                    var p = function (e) {
                        e.select();
                    ...
                    function F(e, t) {
                        var n;
                        return (Object.create ? (n = Object.create(e)) : ((B.prototype = e), (n = new B())), t && Te(t, n), n);
                    }
                    ...
                    var mi = (function () {
                        ...
                        return function (u, h) {
                            ...
                            for (var Q = 0, G = v; Q < k; ++Q) {
                                var ee = x[Q];
                                ee == "1" && G == "r" ? (x[Q] = "n") : o.test(ee) && ((G = ee), ee == "r" && (x[Q] = "R"));
                            }
                            ...
                            for (var Ke = 0; Ke < k; ++Ke) {
                                ...
                                if (st == ",") x[Ke] = "N";
                                    ...
                                    for (var Mt = (Ke && x[Ke - 1] == "!") || (Xe < k && x[Xe] == "1") ? "1" : "N", wt = Ke; wt < Xe; ++wt) x[wt] = Mt;
                                    Ke = Xe - 1;
                                }
                            }
                            ...
                            for (var nt = 0; nt < k; ++nt)
                                if (i.test(x[nt])) {
                                    ...
                                    for (
                                        var Qe = (nt ? x[nt - 1] : v) == "L", Tt = (rt < k ? x[rt] : v) == "L", nn = Qe == Tt ? (Qe ? "L" : "R") : v, xr = nt;
                                        xr < rt;
                                        ++xr
                                    )
                                        x[xr] = nn;
                            ...
                            return (
                                h == "ltr" &&
                                    (gt[0].level == 1 && (Jt = u.match(/^\s+/)) && ((gt[0].from = Jt[0].length), gt.unshift(new s(0, 0, Jt[0].length))),
                                    ge(gt).level == 1 && (Jt = u.match(/\s+$/)) && ((ge(gt).to -= Jt[0].length), gt.push(new s(0, k - Jt[0].length, k)))),
                                h == "rtl" ? gt.reverse() : gt
                            );
                        };
                    })();
                    ...
                    function Wn(e) {
                        if (Or == null) {
                            ...
                            (J(e, d("span", [t, document.createTextNode("x")])),
                                e.firstChild.offsetHeight != 0 && (Or = t.offsetWidth <= 1 && t.offsetHeight > 2 && !(b && N < 8)));
                        }
                        var n = Or ? d("span", "​") : d("span", " ", null, "display: inline-block; width: 1px; margin-right: -1px");
...
`,
                    ...
                    function Ir(e) {
                        if (typeof e == "string" && Ht.hasOwnProperty(e)) e = Ht[e];
                            ...
                            if (typeof e == "string" && /^[\w\-]+\/[\w\-]+\+xml$/.test(e)) return Ir("application/xml");
                            if (typeof e == "string" && /^[\w\-]+\/[\w\-]+\+json$/.test(e)) return Ir("application/json");
                        }
                        ...
                        (Je.prototype.column = function () {
                            return (
                                this.lastColumnPos < this.start &&
                                    ...
                                    (this.lastColumnPos = this.start)),
                                this.lastColumnValue - (this.lineStart ? Le(this.string, this.lineStart, this.tabSize) : 0)
                            );
                        }),
                    ...
                    ((Xt.prototype.lookAhead = function (e) {
                        ...
                        (Xt.fromSaved = function (e, t, n) {
                            return t instanceof Hn ? new Xt(e, Gt(e.mode, t.state), n, t.lookAhead) : new Xt(e, Gt(e.mode, t), n);
                        }),
                    ...
                    function bi(e, t, n, r) {
                        ...
                        for (o.start = o.pos = r || 0, t == "" && yo(i, n.state); !o.eol(); ) (ki(i, o, n.state), (o.start = o.pos));
                    }
                    function yo(e, t) {
                    ...
                    function bo(e, t, n, r) {
                        ...
                        for (r && (h = []); (r || u.pos < t.ch) && !u.eol(); )
                            ((u.start = u.pos), (l = ki(o, u, s.state)), r && h.push(new xo(u, l, Gt(i.mode, s.state))));
                    ...
                    function wi(e, t) {
                        ...
                        if (!u) {
                            var Q = t.text.length - 2,
                                G;
                            if (Q > 0 && a) for (var ee = 0; ee < a.length; ++ee) a[ee].to == null && (G || (G = [])).push(new Rn(a[ee].marker, null, null));
                    ...
                    function Do(e, t) {
                        ...
                        if (n)
                            for (var i = void 0, o = 0; o < n.length; ++o)
                                ((i = n[o]), i.marker.collapsed && (t ? i.from : i.to) == null && (!r || Si(r, i.marker) < 0) && (r = i.marker));
                        return r;
                    }
                    function Mo(e) {
                        return Do(e, !0);
                        ...
                        if (l)
                            for (var a = 0; a < l.length; ++a) {
                                ...
                                if (s.marker.collapsed) {
                                    ...
                                    if (
                                        !((h >= 0 && v <= 0) || (h <= 0 && v >= 0)) &&
                                        ((h <= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? Z(u.to, n) >= 0 : Z(u.to, n) > 0)) ||
                                            (h >= 0 && (s.marker.inclusiveRight && i.inclusiveLeft ? Z(u.from, r) <= 0 : Z(u.from, r) < 0)))
                                    )
                                        return !0;
                                }
                            }
                        ...
                        if (n) {
                            for (var r = void 0, i = 0; i < n.length; ++i)
                                if (((r = n[i]), !!r.marker.collapsed)) {
                                    ...
                                    if (!r.marker.widgetNode && r.from == 0 && r.marker.inclusiveLeft && Li(e, t, r)) return !0;
                                }
                        }
                    }
                    function Li(e, t, n) {
                    ...
                    function No(e, t) {
                        ...
                        for (var i = 0; i <= (t.rest ? t.rest.length : 0); i++) {
                            ...
                            ((r.pos = 0),
                                (r.addToken = ns),
                                sr(e.display.measure) && (l = We(o, e.doc.direction)) && (r.addToken = os(r.addToken, l)),
                                (r.map = []));
                            var a = t != e.display.externalMeasured && f(o);
                            (ls(o, r, mo(e, o, a)),
                                o.styleClasses &&
                                    (o.styleClasses.bgClass && (r.bgClass = le(o.styleClasses.bgClass, r.bgClass || "")),
                                    o.styleClasses.textClass && (r.textClass = le(o.styleClasses.textClass, r.textClass || ""))),
                        ...
                        return (Ye(e, "renderLine", e, t.line, r.pre), r.pre.className && (r.textClass = le(r.pre.className, r.textClass || "")), r);
                    }
                    function rs(e) {
...
`
                            ...
                            if (((e.trailingSpace = a.charCodeAt(t.length - 1) == 32), n || r || i || u || o || l)) {
                                ...
                                (r && (Q += r), i && (Q += i));
                                var G = d("span", [h], Q, o);
                                if (l) for (var ee in l) l.hasOwnProperty(ee) && ee != "style" && ee != "class" && G.setAttribute(ee, l[ee]);
                    ...
                    function os(e, t) {
                        return function (n, r, i, o, l, a, s) {
                            ...
                            for (var u = n.pos, h = u + r.length; ; ) {
                                for (var v = void 0, k = 0; k < t.length && ((v = t[k]), !(v.to > u && v.from <= u)); k++);
                    ...
                    function ls(e, t, n) {
                        var r = e.markedSpans,
                            ...
                            o = 0;
                        if (!r) {
                            for (var l = 1; l < n.length; l += 2) t.addToken(t, i.slice(o, (o = n[l])), Eo(n[l + 1], t.cm.options));
                            return;
                        }
                        for (var a = i.length, s = 0, u = 1, h = "", v, k, x = 0, M, E, R, U, Q; ; ) {
                            if (x == s) {
                                ...
                                for (var G = [], ee = void 0, me = 0; me < r.length; ++me) {
                                    ...
                                    else if (pe.from <= s && (pe.to == null || pe.to > s || (Fe.collapsed && pe.to == s && pe.from == s))) {
                                        if (
                                ...
                                if (ee) for (var st = 0; st < ee.length; st += 2) ee[st + 1] == x && (E += " " + ee[st]);
                                if (!U || U.from == s) for (var Xe = 0; Xe < G.length; ++Xe) Oo(t, 0, G[Xe]);
                                if (U && (U.from || 0) == s) {
                                    if ((Oo(t, (U.to == null ? a + 1 : U.to) - s, U.marker, U.from == null), U.to == null)) return;
                                    U.to == s && (U = !1);
                                }
                            }
                            if (s >= a) break;
                    ...
                    function Io(e, t, n, r) {
                        for (var i = 0; i < t.changes.length; i++) {
                            var o = t.changes[i];
                            o == "text" ? ds(e, t) : o == "gutter" ? Bo(e, t, n, r) : o == "class" ? Di(e, t) : o == "widget" && hs(e, t, r);
                        }
                        t.changes = null;
                    }
                    function hn(e) {
                    ...
                    function Di(e, t) {
                        (cs(e, t), t.line.wrapClass ? (hn(t).className = t.line.wrapClass) : t.node != t.text && (t.node.className = ""));
                        ...
                        if (e.options.lineNumbers || o) {
                            ...
                            if (
                                ...
                                for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
                                    ...
                                    h &&
                                        a.appendChild(
                                            d("div", [h], "CodeMirror-gutter-elt", "left: " + r.gutterLeft[u] + "px; width: " + r.gutterWidth[u] + "px")
                                        );
                                }
                        }
                    }
                    ...
                    function Wo(e, t, n) {
                        if ((_o(e, t.line, t, n, !0), t.rest)) for (var r = 0; r < t.rest.length; r++) _o(e, t.rest[r], t, n, !1);
                    }
                    function _o(e, t, n, r, i) {
                        if (t.widgets)
                            for (var o = hn(n), l = 0, a = t.widgets; l < a.length; ++l) {
                                var s = a[l],
                                    u = d("div", [s.node], "CodeMirror-linewidget" + (s.className ? " " + s.className : ""));
                    ...
                    function Ro(e, t, n) {
                        ...
                        if (e.rest) {
                            ...
                            for (var i = 0; i < e.rest.length; i++)
                                if (f(e.rest[i]) > n) return { map: e.measure.maps[i], cache: e.measure.caches[i], before: !0 };
                        }
                    }
                    function ms(e, t) {
                        t = qt(t);
                    ...
                    function qr(e, t) {
                        var n = f(t),
                            r = Ai(e, n);
                        (r && !r.text ? (r = null) : r && r.changes && (Io(e, r, n, Ii(e)), (e.curOp.forceUpdate = !0)), r || (r = ms(e, t)));
                        var i = Ro(r, t, n);
                    ...
                    function xs(e, t, n, r) {
                        ...
                        if (o.nodeType == 3) {
                            for (var h = 0; h < 4; h++) {
                                ...
                                for (; i.coverStart + a < i.coverEnd && Me(t.line.text.charAt(i.coverStart + a)); ) ++a;
                                if (
                        ...
                        if (b && N < 9 && !l && (!u || (!u.left && !u.right))) {
                            ...
                            k ? (u = { left: k.left, right: k.left + Kr(e.display), top: k.top, bottom: k.bottom }) : (u = jo);
                        }
                        for (
                            var x = u.top - t.rect.top, M = u.bottom - t.rect.top, E = (x + M) / 2, R = t.view.measure.heights, U = 0;
                            U < R.length - 1 && !(E < R[U]);
                            U++
                        );
                        var Q = U ? R[U - 1] : 0,
                        ...
                        return (!u.left && !u.right && (ee.bogus = !0), e.options.singleCursorHeightPerLine || ((ee.rtop = x), (ee.rbottom = M)), ee);
                    }
                    function bs(e, t) {
                        if (!window.screen || screen.logicalXDPI == null || screen.logicalXDPI == screen.deviceXDPI || !xi(e)) return t;
                    ...
                    function ks(e, t, n, r, i) {
                        ...
                        var k = null,
                            ...
                            M = Nt(
                                function (me) {
                                    var pe = Zt(e, o, me);
                                    return ((pe.top += l), (pe.bottom += l), Pi(pe, r, i, !1) ? (pe.top <= i && pe.left <= r && ((k = me), (x = pe)), !0) : !1);
                                },
                                a,
                                s
                            ),
                        ...
                        if (x) {
                            ...
                            (!u && (M == s || M == a) && M++,
                                (R = M == 0 ? "after" : M == t.text.length ? "before" : Zt(e, o, M - (u ? 1 : 0)).bottom + l <= i == u ? "after" : "before"));
                    ...
                    function ws(e, t, n, r, i, o, l) {
                        var a = Nt(
                                function (v) {
                                    var k = i[v],
                                        x = k.level != 1;
                                    return Pi(jt(e, L(n, x ? k.to : k.from, x ? "before" : "after"), "line", t, r), o, l, !0);
                                },
                                0,
                                i.length - 1
                            ),
                    ...
                    function jr(e) {
                        ...
                        if (Sr == null) {
                            ...
                            for (var t = 0; t < 49; ++t) (Sr.appendChild(document.createTextNode("x")), Sr.appendChild(d("br")));
                    ...
                    function Ii(e) {
                        ...
                        return { fixedPos: zi(t), gutterTotalWidth: t.gutters.offsetWidth, gutterLeft: n, gutterWidth: r, wrapperWidth: t.wrapper.clientWidth };
                    }
                    function zi(e) {
                    ...
                    function bt(e, t, n, r) {
                        ...
                        else if (n <= i.viewFrom) $t && Ao(e.doc, n + r) > i.viewFrom ? hr(e) : ((i.viewFrom += r), (i.viewTo += r));
                    ...
                    function Ts(e, t, n) {
                        ...
                        (i.length == 0 || t >= r.viewTo || n <= r.viewFrom
                            ...
                            : (r.viewFrom > t ? (r.view = Gn(e, t, r.viewFrom).concat(r.view)) : r.viewFrom < t && (r.view = r.view.slice(Lr(e, t))),
                              (r.viewFrom = t),
                              r.viewTo < n ? (r.view = r.view.concat(Gn(e, r.viewTo, n))) : r.viewTo > n && (r.view = r.view.slice(0, Lr(e, n)))),
                            (r.viewTo = n));
                    }
                    function el(e) {
                        ...
                        function v(G, ee, me) {
                            ...
                            function Mt(tt, St, ft) {
                                var nt = Vo(e, pe, null, tt),
                                    ...
                                    Qe = ft == "after" ? nt.begin : nt.end - (/\s/.test(pe.text.charAt(nt.end - 1)) ? 2 : 1);
                                return Xe(Qe, rt)[rt];
                            }
                            ...
                            ((t.cursorDiv.style.visibility = ""),
                                e.options.cursorBlinkRate > 0
                                    ? (t.blinker = setInterval(function () {
                                          (e.hasFocus() || Ur(e), (t.cursorDiv.style.visibility = (n = !n) ? "" : "hidden"));
                    ...
                    function Hi(e) {
                        ((e.state.delayingBlurEvent = !0),
                            setTimeout(function () {
                                e.state.delayingBlurEvent && ((e.state.delayingBlurEvent = !1), e.state.focused && Ur(e));
                            }, 100));
                    }
                    function Ri(e, t) {
                    ...
                    function Ur(e, t) {
                        e.state.delayingBlurEvent ||
                            (e.state.focused && (Ye(e, "blur", e, t), (e.state.focused = !1), Ee(e.display.wrapper, "CodeMirror-focused")),
                        ...
                        for (
                            ...
                            if (!a.hidden) {
                                if (((i += a.line.height), b && N < 8)) {
                                    ...
                                    ((u = k.bottom - k.top), !s && a.text.firstChild && (h = a.text.firstChild.getBoundingClientRect().right - k.left - 1));
                                }
                                var x = a.line.height - u;
                                if ((x > 0.005 || x < -0.005) && (i < r && (o -= x), Ft(a.line, u), nl(a.line), a.rest))
                                ...
                                if (h > e.display.sizerWidth) {
                                    ...
                                    E > e.display.maxLineLength &&
                                        ((e.display.maxLineLength = E), (e.display.maxLine = a.line), (e.display.maxLineChanged = !0));
                                }
                            }
                        }
                    ...
                    function $n(e, t, n) {
                        ...
                        if (n && n.ensure) {
                            ...
                            a < o
                                ...
                                : Math.min(s, t.lastLine()) >= l && ((o = g(t, er(ce(t, s)) - e.wrapper.clientHeight)), (l = s));
                        }
                    ...
                    function Cs(e, t) {
                        if (!Ze(e, "scrollCursorIntoView")) {
                            ...
                            if (
                                (t.top + r.top < 0 ? (i = !0) : t.bottom + r.top > (o.defaultView.innerHeight || o.documentElement.clientHeight) && (i = !1),
                                i != null && !we)
                            ) {
                                var l = d(
                                    "div",
                    ...
                    function Ds(e, t, n, r) {
                        ...
                        for (var o = 0; o < 5; o++) {
                            ...
                            var u = qi(e, i),
                                ...
                                v = e.doc.scrollLeft;
                            if (
                                (u.scrollTop != null && (yn(e, u.scrollTop), Math.abs(e.doc.scrollTop - h) > 1 && (l = !0)),
                                u.scrollLeft != null && (Cr(e, u.scrollLeft), Math.abs(e.doc.scrollLeft - v) > 1 && (l = !0)),
                                !l)
                            )
                                break;
                        }
                    ...
                    function qi(e, t) {
                        ...
                        var v = e.options.fixedGutter ? 0 : n.gutters.offsetWidth,
                            k = e.curOp && e.curOp.scrollLeft != null ? e.curOp.scrollLeft : n.scroller.scrollLeft - v,
                    ...
                    function yn(e, t) {
                        Math.abs(e.doc.scrollTop - t) < 2 || (I || Ui(e, { top: t }), ol(e, t, !0), I && Ui(e), kn(e, 100));
                    }
                    function ol(e, t, n) {
                    ...
                    var Dr = function (e, t, n) {
                        ...
                        var r = (this.vert = d("div", [d("div", null, null, "min-width: 1px")], "CodeMirror-vscrollbar")),
                            i = (this.horiz = d("div", [d("div", null, null, "height: 100%; min-height: 1px")], "CodeMirror-hscrollbar"));
                    ...
                    function Xr(e, t) {
                        ...
                        for (var i = 0; (i < 4 && n != e.display.barWidth) || r != e.display.barHeight; i++)
                            (n != e.display.barWidth && e.options.lineWrapping && Vn(e), ll(e, xn(e)), (n = e.display.barWidth), (r = e.display.barHeight));
                    }
                    function ll(e, t) {
                        var n = e.display,
                    ...
                    function sl(e) {
                        (e.display.scrollbars &&
                            (e.display.scrollbars.clear(), e.display.scrollbars.addClass && Ee(e.display.wrapper, e.display.scrollbars.addClass)),
                    ...
                    function Ns(e) {
                        ...
                        (Ws(t),
                            ...
                            (e.update = e.mustUpdate && new ti(t, e.mustUpdate && { top: e.scrollTop, ensure: e.scrollToPos }, e.forceUpdate)));
                    }
                    function Os(e) {
                    ...
                    function zs(e) {
                        ...
                        if (
                            ...
                            n.wheelStartX != null && (e.scrollTop != null || e.scrollLeft != null || e.scrollToPos) && (n.wheelStartX = n.wheelStartY = null),
                            e.scrollTop != null && ol(t, e.scrollTop, e.forceScroll),
                            e.scrollLeft != null && Cr(t, e.scrollLeft, !0, !0),
                            e.scrollToPos)
                        ) {
                            var i = Ds(t, Ce(r, e.scrollToPos.from), Ce(r, e.scrollToPos.to), e.scrollToPos.margin);
                            Cs(t, i);
                        }
                                ...
                                if (r.line >= e.display.viewFrom) {
                                    ...
                                    for (
                                        var v =
                                                ...
                                                (u != h && (!u || !h || u.bgClass != h.bgClass || u.textClass != h.textClass)),
                                            k = 0;
                                        !v && k < l.length;
                                        ++k
                                    )
                    ...
                    function Hs(e) {
                        if (
                            ...
                            (e.activeElt.focus(),
                            !/^(INPUT|TEXTAREA)$/.test(e.activeElt.nodeName) && e.anchorNode && m(document.body, e.anchorNode) && m(document.body, e.focusNode))
                        ) {
                    ...
                    function Ki(e, t) {
                        ...
                        (Ts(e, o, l), (n.viewOffset = er(ce(e.doc, n.viewFrom))), (e.display.mover.style.top = n.viewOffset + "px"));
                        var s = el(e);
                        ...
                        return (
                            ...
                            a && ((n.lastWrapHeight = t.wrapperHeight), (n.lastWrapWidth = t.wrapperWidth), kn(e, 400)),
                    ...
                    function ul(e, t) {
                        for (var n = t.viewport, r = !0; ; r = !1) {
                            if (!r || !e.options.lineWrapping || t.oldDisplayWidth == wr(e)) {
                                if (
                                    (n && n.top != null && (n = { top: Math.min(e.doc.height + Mi(e.display) - Fi(e), n.top) }),
                    ...
                    function Rs(e, t, n) {
                        ...
                        function a(M) {
                            var E = M.nextSibling;
                            return (_ && se && e.display.currentWheelTarget == M ? (M.style.display = "none") : M.parentNode.removeChild(M), E);
                        }
                            ...
                            if (!v.hidden)
                                if (!v.node || v.node.parentNode != o) {
                                    ...
                                    (v.changes && (oe(v.changes, "gutter") > -1 && (x = !1), Io(e, v, u, n)),
                                        x && (D(v.lineNumber), v.lineNumber.appendChild(document.createTextNode(W(e.options, u)))),
                    ...
                    function fl(e) {
                        ...
                        if (!(!t.alignWidgets && (!t.gutters.firstChild || !e.options.fixedGutter))) {
                            for (var r = zi(t) - t.scroller.scrollLeft + e.doc.scrollLeft, i = t.gutters.offsetWidth, o = r + "px", l = 0; l < n.length; l++)
                                if (!n[l].hidden) {
                                    e.options.fixedGutter &&
                                        (n[l].gutter && (n[l].gutter.style.left = o), n[l].gutterBackground && (n[l].gutterBackground.style.left = o));
                                    var a = n[l].alignable;
                    ...
                    function qs(e, t, n, r) {
                        ...
                        ((i.mover = d("div", [o], null, "position: relative")),
                            ...
                            (i.sizerWidth = null),
                            (i.heightForcer = d("div", null, null, "position: absolute; height: " + Ne + "px; width: 1px;")),
                    ...
                    function pl(e, t) {
                        O &&
                            q == 102 &&
                            (e.display.chromeScrollHack == null ? (e.display.sizer.style.pointerEvents = "none") : clearTimeout(e.display.chromeScrollHack),
                        ...
                        if ((r && s) || (i && u)) {
                            ...
                            if (i && o != null) {
                                ...
                                (x < 0 ? (M = Math.max(0, M + x - 50)) : (E = Math.min(e.doc.height, E + x + 50)), Ui(e, { top: M, bottom: E }));
                            }
                            ri < 20 &&
                                t.deltaMode !== 0 &&
                                (l.wheelStartX == null
                                    ? ((l.wheelStartX = a.scrollLeft),
                                      ...
                                      setTimeout(function () {
                                          if (l.wheelStartX != null) {
                                              ...
                                              ((l.wheelStartX = l.wheelStartY = null), Q && ((rr = (rr * ri + Q) / (ri + 1)), ++ri));
                                          }
                                      }, 200))
                    ...
                    ((At.prototype.primary = function () {
                        ...
                        (At.prototype.deepCopy = function () {
                            for (var e = [], t = 0; t < this.ranges.length; t++) e[t] = new He(it(this.ranges[t].anchor), it(this.ranges[t].head));
                    ...
                    function gr(e) {
                        return e.text ? L(e.from.line + e.text.length - 1, ge(e.text).length + (e.text.length == 1 ? e.from.ch : 0)) : e.to;
                    }
                    function gl(e, t) {
                    ...
                    function ml(e, t) {
                        return t.from.ch == 0 && t.to.ch == 0 && ge(t.text) == "" && (!e.cm || e.cm.options.wholeLineUpdateBefore);
                    }
                    function Qi(e, t, n, r) {
                        function i(Q) {
                            return n ? n[Q] : null;
                        ...
                        if (t.full) (e.insert(0, l(0, u.length)), e.remove(u.length, e.size - u.length));
                            ...
                            if (u.length == 1) o(h, h.text.slice(0, a.ch) + k + h.text.slice(s.ch), x);
                                ...
                                (R.push(new Hr(k + h.text.slice(s.ch), x, r)), o(h, h.text.slice(0, a.ch) + u[0], i(0)), e.insert(a.line + 1, R));
                            }
                        else if (u.length == 1) (o(h, h.text.slice(0, a.ch) + u[0] + v.text.slice(s.ch), i(0)), e.remove(a.line + 1, M));
                        else {
                    ...
                    function Gs(e, t) {
                        ...
                        if (e.done.length > 1 && !e.done[e.done.length - 2].ranges) return (e.done.pop(), ge(e.done));
                    }
                    function kl(e, t, n, r) {
                        var i = e.history;
                        i.undone.length = 0;
                        ...
                        if (
                            ...
                            ((a = ge(l.changes)), Z(t.from, t.to) == 0 && Z(t.from, a.to) == 0 ? (a.to = gr(t)) : l.changes.push(Vi(e, t)));
                        else {
                            var s = ge(i.done);
                            for (
                                (!s || !s.ranges) && ii(e.sel, i.done), l = { changes: [Vi(e, t)], generation: i.generation }, i.done.push(l);
                    ...
                    function Ys(e, t, n, r) {
                        var i = e.history,
                            o = r && r.origin;
                        (n == i.lastSelOp || (o && i.lastSelOrigin == o && ((i.lastModTime == i.lastSelTime && i.lastOrigin == o) || Xs(e, o, ge(i.done), t)))
                        ...
                        for (var r = [], i = 0; i < e.length; ++i) {
                            ...
                            for (var s = 0; s < l.length; ++s) {
                                ...
                                if ((a.push({ from: u.from, to: u.to, text: u.text }), t))
                                    for (var v in u) (h = v.match(/^spans_(\d+)$/)) && oe(t, Number(h[1])) > -1 && ((ge(a)[v] = u[v]), delete u[v]);
                            }
                        }
                        return r;
                    }
                    ...
                    function oi(e, t, n, r, i) {
                        (i == null && (i = e.cm && (e.cm.display.shift || e.extend)), pt(e, new At([$i(e.sel.primary(), t, n, i)], 0), r));
                    }
                    function Tl(e, t, n) {
                    ...
                    function Qs(e, t, n) {
                        var r = {
                            ...
                            update: function (i) {
                                this.ranges = [];
                                for (var o = 0; o < i.length; o++) this.ranges[o] = new He(Ce(e, i[o].anchor), Ce(e, i[o].head));
                            },
                            origin: n && n.origin
                        };
                        return (
                    ...
                    function li(e, t, n) {
                        (Ct(e, "beforeSelectionChange") || (e.cm && Ct(e.cm, "beforeSelectionChange"))) && (t = Qs(e, t, n));
                        var r = (n && n.bias) || (Z(t.primary().head, e.sel.primary().head) < 0 ? -1 : 1);
                        (Dl(e, Fl(e, t, r, !0)), !(n && n.scroll === !1) && e.cm && e.cm.getOption("readOnly") != "nocursor" && Gr(e.cm));
                    }
                    function Dl(e, t) {
                        t.equals(e.sel) ||
                            ((e.sel = t), e.cm && ((e.cm.curOp.updateInput = 1), (e.cm.curOp.selectionChanged = !0), Ot(e.cm)), ot(e, "cursorActivity", e));
                    }
                    function Ml(e) {
                    ...
                    function Fl(e, t, n, r) {
                        for (var i, o = 0; o < t.ranges.length; o++) {
                            ...
                            (i || s != l.anchor || u != l.head) && (i || (i = t.ranges.slice(0, o)), (i[o] = new He(s, u)));
                        }
                        ...
                        if (o.markedSpans)
                            for (var l = 0; l < o.markedSpans.length; ++l) {
                                ...
                                if ((a.from == null || (u ? a.from <= t.ch : a.from < t.ch)) && (a.to == null || (h ? a.to >= t.ch : a.to > t.ch))) {
                                    ...
                                    return ((r < 0 ? u : h) && (x = Al(e, x, r, x.line == t.line ? o : null)), x ? Zr(e, x, t, r, i) : null);
                                }
                            }
                        return t;
                    }
                    function ai(e, t, n, r, i) {
                        var o = r || 1,
                            l = Zr(e, t, n, o, i) || (!i && Zr(e, t, n, o, !0)) || Zr(e, t, n, -o, i) || (!i && Zr(e, t, n, -o, !0));
                        ...
                        return (
                            n &&
                                (r.update = function (i, o, l, a) {
                                    (i && (r.from = Ce(e, i)), o && (r.to = Ce(e, o)), l && (r.text = l), a !== void 0 && (r.origin = a));
                                }),
                    ...
                    function Jr(e, t, n) {
                        ...
                        if (!((Ct(e, "beforeChange") || (e.cm && Ct(e.cm, "beforeChange"))) && ((t = Nl(e, t, !0)), !t))) {
                            var r = So && !n && Ya(e, t.from, t.to);
                            if (r) for (var i = r.length - 1; i >= 0; --i) Ol(e, { from: r[i].from, to: r[i].to, text: i ? [""] : t.text, origin: t.origin });
                            else Ol(e, t);
                        }
                    }
                    function Ol(e, t) {
                        if (!(t.text.length == 1 && t.text[0] == "" && Z(t.from, t.to) == 0)) {
                            ...
                            var r = [];
                            vr(e, function (i, o) {
                                (!o && oe(r, i.history) == -1 && (Bl(i.history, t), r.push(i.history)), Tn(i, t, null, wi(i, t)));
                            });
                        }
                    }
                    function si(e, t, n) {
                        ...
                        if (!(r && !n)) {
                            for (
                                var i = e.history, o, l = e.sel, a = t == "undo" ? i.done : i.undone, s = t == "undo" ? i.undone : i.done, u = 0;
                                ...
                                for (
                                    var v = Ct(e, "beforeChange") || (e.cm && Ct(e.cm, "beforeChange")),
                                        k = function (E) {
                                            ...
                                            h.push(Vi(e, R));
                                            var U = E ? Zi(e, R) : ge(a);
                                            (Tn(e, R, U, Sl(e, R)), !E && e.cm && e.cm.scrollIntoView({ from: R.from, to: gr(R) }));
                                            var Q = [];
                                            vr(e, function (G, ee) {
                                                (!ee && oe(Q, G.history) == -1 && (Bl(G.history, R), Q.push(G.history)), Tn(G, R, null, Sl(G, R)));
                                            });
                                        },
                    ...
                    function Tn(e, t, n, r) {
                        ...
                        if (!(t.from.line > e.lastLine())) {
                            if (t.from.line < e.first) {
                                ...
                                (Pl(e, i), (t = { from: L(e.first, 0), to: L(t.to.line + i, t.to.ch), text: [ge(t.text)], origin: t.origin }));
                            }
                            var o = e.lastLine();
                            (t.to.line > o && (t = { from: t.from, to: L(o, ce(e, o).text.length), text: [t.text[0]], origin: t.origin }),
                        ...
                        (e.options.lineWrapping ||
                            ...
                            e.options.lineWrapping ||
                                (r.iter(s, o.line + t.text.length, function (x) {
                                    var M = Un(x);
                                    M > i.maxLineLength && ((i.maxLine = x), (i.maxLineLength = M), (i.maxLineChanged = !0), (a = !1));
                                }),
                                a && (e.curOp.updateMaxLine = !0)),
                            Ra(r, o.line),
                            kn(e, 400));
                        var u = t.text.length - (l.line - o.line) - 1;
                        t.full ? bt(e) : o.line == l.line && t.text.length == 1 && !ml(e.doc, t) ? dr(e, o.line, "text") : bt(e, o.line, l.line + 1, u);
                        var h = Ct(e, "changes"),
                            v = Ct(e, "change");
                        if (v || h) {
                            var k = { from: o, to: l, text: t.text, removed: t.removed, origin: t.origin };
                            (v && ot(e, "change", e, k), h && (e.curOp.changeObjs || (e.curOp.changeObjs = [])).push(k));
                        }
                    ...
                    function zl(e, t, n, r) {
                        for (var i = 0; i < e.length; ++i) {
                            ...
                            if (o.ranges) {
                                ...
                                for (var a = 0; a < o.ranges.length; a++) (Il(o.ranges[a].anchor, t, n, r), Il(o.ranges[a].head, t, n, r));
                                continue;
                            }
                            for (var s = 0; s < o.changes.length; ++s) {
                                var u = o.changes[s];
                                if (n < u.from.line) ((u.from = L(u.from.line + r, u.from.ch)), (u.to = L(u.to.line + r, u.to.ch)));
                                else if (t <= u.to.line) {
                                    l = !1;
                                    break;
                                }
                    ...
                    function Ln(e, t, n, r) {
                        var i = t,
                            o = t;
                        return (typeof t == "number" ? (o = ce(e, po(e, t))) : (i = f(t)), i == null ? null : (r(o, i) && e.cm && dr(e.cm, i, n), o));
                    }
                    function Cn(e) {
                    ...
                    function $s(e, t, n, r) {
                        ...
                        return (
                            ...
                            Ln(e, t, "widget", function (l) {
                                ...
                                if (
                                    (i.insertAt == null ? a.push(i) : a.splice(Math.min(a.length, Math.max(0, i.insertAt)), 0, i), (i.line = l), o && !cr(e, l))
                                ) {
                    ...
                    ((mr.prototype.clear = function () {
                        if (!this.explicitlyCleared) {
                            ...
                            for (var r = null, i = null, o = 0; o < this.lines.length; ++o) {
                                ...
                                (e && !this.collapsed ? dr(e, f(l), "text") : e && (a.to != null && (i = f(l)), a.from != null && (r = f(l))),
                    ...
                    function Vr(e, t, n, r, i) {
                        ...
                        if (
                            (e.iter(a, n.line + 1, function (v) {
                                (s && o.collapsed && !s.options.lineWrapping && qt(v) == s.display.maxLine && (u = !0),
                                    o.collapsed && a != t.line && Ft(v, 0),
                                    Ua(v, new Rn(o, a == t.line ? t.ch : null, a == n.line ? n.ch : null), e.cm && e.cm.curOp),
                                    ++a);
                            }),
                            o.collapsed &&
                            ...
                            o.readOnly && (qa(), (e.history.done.length || e.history.undone.length) && e.clearHistory()),
                    ...
                    ((kt.prototype = F(Dn.prototype, {
                        ...
                        setValue: at(function (e) {
                            ...
                            (Jr(this, { from: t, to: L(n, ce(this, n).text.length), text: this.splitLines(e), origin: "setValue", full: !0 }, !0),
                        ...
                        setSelections: at(function (e, t, n) {
                            if (e.length) {
                                for (var r = [], i = 0; i < e.length; i++) r[i] = new He(Ce(this, e[i].anchor), Ce(this, e[i].head || e[i].anchor));
                                (t == null && (t = Math.min(e.length - 1, this.sel.primIndex)), pt(this, Kt(this.cm, r, t), n));
                            }
                        }),
                        addSelection: at(function (e, t, n) {
                            var r = this.sel.ranges.slice(0);
                            (r.push(new He(Ce(this, e), Ce(this, t || e))), pt(this, Kt(this.cm, r, r.length - 1), n));
                        }),
                        ...
                        replaceSelections: at(function (e, t, n) {
                            ...
                            for (var a = t && t != "end" && Ks(this, r, t), s = r.length - 1; s >= 0; s--) Jr(this, r[s]);
                            ...
                            this.iter(function (n) {
                                n.gutterMarkers &&
                                    ...
                                    Ln(t, n, "gutter", function () {
                                        return ((n.gutterMarkers[e] = null), he(n.gutterMarkers) && (n.gutterMarkers = null), !0);
                                    });
                            });
                        }),
                        lineInfo: function (e) {
                        ...
                        copy: function (e) {
                            var t = new kt(un(this, this.first, this.first + this.size), this.modeOption, this.first, this.lineSep, this.direction);
                            return (
                        ...
                        linkedDoc: function (e) {
                            ...
                            var r = new kt(un(this, t, n), e.mode || this.modeOption, t, this.lineSep, this.direction);
                            return (
...
`
                                ...
                                if (r && r.length && window.FileReader && window.File)
                                    for (
                                        var i = r.length,
                                            ...
                                            s = function (x, M) {
                                                if (t.options.allowDropFileTypes && oe(t.options.allowDropFileTypes, x.type) == -1) {
                                                    a();
                                                    return;
                                                }
                                    ...
                                    try {
                                        ...
                                        if (h) {
                                            var v;
                                            if ((t.state.draggingText && !t.state.draggingText.copy && (v = t.listSelections()), li(t.doc, pr(n, n)), v))
                                                for (var k = 0; k < v.length; ++k) Qr(t.doc, "", v[k].anchor, v[k].head, "drag");
                    ...
                    function ou(e, t) {
                        ...
                        if (
                            ...
                            (t.dataTransfer.setData("Text", e.getSelection()), (t.dataTransfer.effectAllowed = "copyMove"), t.dataTransfer.setDragImage && !X)
                        ) {
                            ...
                            ((n.src = "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw=="),
                                z && ((n.width = n.height = 1), e.display.wrapper.appendChild(n), (n._top = n.offsetTop)),
                    ...
                    function $r(e, t, n, r) {
                        ...
                        if (t.fallthrough) {
                            if (Object.prototype.toString.call(t.fallthrough) != "[object Array]") return $r(e, t.fallthrough, n, r);
                    ...
                    function Xl(e, t) {
                        ...
                        var n = yr[e.keyCode];
                        return n == null || e.altGraphKey ? !1 : (e.keyCode == 3 && e.code && (n = e.code), Gl(n, e, t));
                    }
                    function fi(e) {
                    ...
                    function du(e, t, n, r) {
                        ...
                        var o = lr(i, n.ch, n.sticky),
                            l = i[o];
                        if (e.doc.direction == "ltr" && l.level % 2 == 0 && (r > 0 ? l.to > n.ch : l.from < n.ch)) return ro(t, n, r);
                        var a = function (U, Q) {
                                return to(t, U instanceof L ? U.ch : U, Q);
                            },
                            s,
                            u = function (U) {
                                return e.options.lineWrapping ? ((s = s || qr(e, t)), Vo(e, t, s, U)) : { begin: 0, end: t.text.length };
                            },
                        ...
                        var M = function (U, Q, G) {
                                for (
                                    ...
                                    if ((me.from <= Fe && Fe < me.to) || ((Fe = pe ? me.from : a(me.to, -1)), G.begin <= Fe && Fe < G.end)) return ee(Fe, pe);
                                }
                            },
                            E = M(o + r, r, h);
                        if (E) return E;
                        var R = r > 0 ? h.end : a(h.begin, -1);
                        return R != null && !(r > 0 && R == t.text.length) && ((E = M(r > 0 ? 0 : i.length - 1, r, u(R))), E) ? E : null;
                    }
                    var Nn = {
                        selectAll: El,
                                        ...
                                        if (o) {
                                            if ((i.ch == o.length && (i = new L(i.line, i.ch - 1)), i.ch > 0))
                                                ((i = new L(i.line, i.ch + 1)),
                                                    e.replaceRange(o.charAt(i.ch - 1) + o.charAt(i.ch - 2), L(i.line, i.ch - 2), i, "+transpose"));
...
`,
                    ...
                    function ci(e, t, n) {
                        ...
                        var r = e.display.shift,
                            i = !1;
                        try {
                            (e.isReadOnly() && (e.state.suppressEdits = !0), n && (e.display.shift = !1), (i = t(e) != qe));
                        } finally {
                    ...
                    function pu(e, t, n) {
                        ...
                        return (e.options.extraKeys && $r(t, e.options.extraKeys, n, e)) || $r(t, e.options.keyMap, n, e);
                    }
                    var gu = new be();
                    function On(e, t, n, r) {
                    ...
                    function Vl(e) {
                        var t = this;
                        if (!(e.target && e.target != t.display.input.getField()) && ((t.curOp.focus = y(Y(t))), !Ze(t, e))) {
                            b && N < 11 && e.keyCode == 27 && (e.returnValue = !1);
                            var n = e.keyCode;
                            t.display.shift = n == 16 || e.shiftKey;
                            var r = Ql(t, e);
                            (z && ((io = r ? n : null), !r && n == 88 && !_n && (se ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
                                I && !se && !r && n == 46 && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"),
                    ...
                    function mu(e) {
                        ...
                        function n(r) {
                            (r.keyCode == 18 || !r.altKey) && (Ee(t, "CodeMirror-crosshair"), dt(document, "keyup", n), dt(document, "mouseover", n));
                        }
                        ...
                        var i = e.display,
                            ...
                            l = lt(e, function (u) {
                                (_ && (i.scroller.draggable = !1),
                                    ...
                                    e.state.delayingBlurEvent && (e.hasFocus() ? (e.state.delayingBlurEvent = !1) : Hi(e)),
                    ...
                    function Tu(e, t, n, r) {
                        ...
                        r.addNew
                            ? a == -1
                                ...
                                : u.length > 1 && u[a].empty() && r.unit == "char" && !r.extend
                                  ? (pt(o, Kt(e, u.slice(0, a).concat(u.slice(a + 1)), 0), { scroll: !1, origin: "*mouse" }), (s = o.sel))
                                  : eo(o, a, l, ct)
                            ...
                            if (Z(v, G) != 0)
                                if (((v = G), r.unit == "rectangle")) {
                                    for (
                                        ...
                                        var wt = ce(o, Xe).text,
                                            tt = Re(wt, Ke, me);
                                        Ke == st ? ee.push(new He(L(Xe, tt), L(Xe, tt))) : wt.length > tt && ee.push(new He(L(Xe, tt), L(Xe, Re(wt, st, me))));
                                    }
                                    (ee.length || ee.push(new He(n, n)),
                                        pt(o, Kt(e, s.ranges.slice(0, a).concat(ee), a), { origin: "*mouse", scroll: !1 }),
                                        e.scrollIntoView(G));
                                } else {
                                    var St = l,
                                        ft = ra(e, G, r.unit),
                                        nt = St.anchor,
                                        rt;
                                    Z(ft.anchor, nt) > 0 ? ((rt = ft.head), (nt = _r(St.from(), ft.anchor))) : ((rt = ft.anchor), (nt = xt(St.to(), ft.head)));
                        ...
                        var U = lt(e, function (G) {
                            ...
                            Q = lt(e, R);
                        ((e.state.selectingText = Q), ve(i.wrapper.ownerDocument, "mousemove", U), ve(i.wrapper.ownerDocument, "mouseup", Q));
                    }
                    function Lu(e, t) {
                        var n = t.anchor,
                            r = t.head,
                    ...
                    function ia(e, t) {
                        tr(e.display, t) || Cu(e, t) || Ze(e, t, "contextmenu") || fe || e.display.input.onContextMenu(t);
                    }
                    function Cu(e, t) {
                        ...
                        ((e.defineOption = n),
                            ...
                            n("lineSeparator", null, function (r, i) {
                                if (((r.doc.lineSep = i), !!i)) {
                                    ...
                                    for (var a = o.length - 1; a >= 0; a--) Qr(r.doc, i, o[a], L(o[a].line, o[a].ch + i.length));
                                }
                            }),
                            n(
                                "specialChars",
                                /[\u0000-\u001f\u007f-\u009f\u00ad\u061c\u200b\u200e\u200f\u2028\u2029\u202d\u202e\u2066\u2067\u2069\ufeff\ufff9-\ufffc]/g,
                                function (r, i, o) {
                                    ((r.state.specialChars = new RegExp(i.source + (i.test("	") ? "" : "|	"), "g")), o != tn && r.refresh());
                                }
                            ),
                            n(
                            ...
                            n("readOnly", !1, function (r, i) {
                                (i == "nocursor" && (Ur(r), r.display.input.blur()), r.display.input.readOnlyChanged(i));
                            }),
                    ...
                    function Fu(e) {
                        (e.options.lineWrapping
                            ? (P(e.display.wrapper, "CodeMirror-wrap"), (e.display.sizer.style.minWidth = ""), (e.display.sizerWidth = null))
                    ...
                    function Ge(e, t) {
                        ...
                        var r = t.value;
                        (typeof r == "string" ? (r = new kt(r, t.mode, null, t.lineSeparator, t.direction)) : t.mode && (r.modeOption = t.mode),
                            (this.doc = r));
                    ...
                    function Au(e) {
                        ...
                        (ve(t.scroller, "touchstart", function (s) {
                            ...
                            ve(t.scroller, "scroll", function () {
                                t.scroller.clientHeight && (yn(e, t.scroller.scrollTop), Cr(e, t.scroller.scrollLeft, !0), Ye(e, "scroll", e));
                            }),
                    ...
                    function zn(e, t, n, r) {
                        var i = e.doc,
                            o;
                        (n == null && (n = "add"), n == "smart" && (i.mode.indent ? (o = fn(e, t).state) : (n = "prev")));
                        ...
                        else if (n == "smart" && ((h = i.mode.indent(o, a.text.slice(u.length), a.text)), h == qe || h > 150)) {
                            if (!r) return;
                            n = "prev";
                        }
                        (n == "prev"
                        ...
                        var v = "",
                            k = 0;
                        if (e.options.indentWithTabs) for (var x = Math.floor(h / l); x; --x) ((k += l), (v += "	"));
                        if ((k < h && (v += et(h - k)), v != u)) return (Qr(i, v, L(t, 0), L(t, u.length), "+input"), (a.stateAfter = null), !0);
...
`) &&
                                        (M = E = L(M.line, 0)));
                            var R = { from: M, to: E, text: u ? u[k % u.length] : s, origin: i || (a ? "paste" : e.state.cutIncoming > l ? "cut" : "+input") };
                    ...
                    function fa() {
                        ...
                        return (_ ? (e.style.width = "1000px") : e.setAttribute("wrap", "off"), te && (e.style.border = "1px solid black"), t);
                    }
                    function Eu(e) {
                        var t = e.optionHandlers,
                            n = (e.helpers = {});
                        ((e.prototype = {
                            ...
                            setOption: function (r, i) {
                                var o = this.options,
                                    l = o[r];
                                (o[r] == i && r != "mode") ||
                                    ((o[r] = i), t.hasOwnProperty(r) && lt(this, t[r])(this, i, l), Ye(this, "optionChange", this, r));
                            },
                            ...
                            removeKeyMap: function (r) {
                                for (var i = this.state.keyMaps, o = 0; o < i.length; ++o) if (i[o] == r || i[o].name == r) return (i.splice(o, 1), !0);
                            },
                            addOverlay: vt(function (r, i) {
                                ...
                                (T(this.state.overlays, { mode: o, modeSpec: r, opaque: i && i.opaque, priority: (i && i.priority) || 0 }, function (l) {
                                    return l.priority;
                                }),
                                    this.state.modeGen++,
                                    bt(this));
                            ...
                            indentSelection: vt(function (r) {
                                for (var i = this.doc.sel.ranges, o = -1, l = 0; l < i.length; l++) {
                                    var a = i[l];
                                    if (a.empty())
                                        a.head.line > o && (zn(this, a.head.line, r, !0), (o = a.head.line), l == this.doc.sel.primIndex && Gr(this));
                                    else {
                                        var s = a.from(),
                                            u = a.to(),
                                            h = Math.max(o, s.line);
                                        ...
                                        s.ch == 0 && i.length == k.length && k[l].from().ch > 0 && eo(this.doc, l, new He(s, k[l].to()), Ve);
                                    }
                                }
                            }),
                            ...
                            cursorCoords: function (r, i) {
                                ...
                                return (
                                    r == null ? (o = l.head) : typeof r == "object" ? (o = Ce(this.doc, r)) : (o = r ? l.from() : l.to()),
                                    jt(this, o, i || "page")
                                );
                            },
                            ...
                            lineAtHeight: function (r, i) {
                                return ((r = Zo(this, { top: r, left: 0 }, i || "page").top), g(this.doc, r + this.display.viewOffset));
                            },
                            heightAtLine: function (r, i, o) {
                                ...
                                if (typeof r == "number") {
                                    ...
                                    (r < this.doc.first ? (r = this.doc.first) : r > s && ((r = s), (l = !0)), (a = ce(this.doc, r)));
                                } else a = r;
                                return Yn(this, a, { top: 0, left: 0 }, i || "page", o || l).top + (l ? this.doc.height - er(a) : 0);
                            },
                            ...
                            addWidget: function (r, i, o, l, a) {
                                ...
                                ((i.style.top = u + "px"),
                                    ...
                                    a == "right"
                                        ...
                                        : (a == "left" ? (h = 0) : a == "middle" && (h = (s.sizer.clientWidth - i.offsetWidth) / 2), (i.style.left = h + "px")),
                                    o && Ms(this, { left: h, top: u, right: h + i.offsetWidth, bottom: u + i.offsetHeight }));
                            },
                            ...
                            findPosH: function (r, i, o, l) {
                                var a = 1;
                                i < 0 && ((a = -1), (i = -i));
                                for (var s = Ce(this.doc, r), u = 0; u < i && ((s = fo(this.doc, s, a, o, l)), !s.hitSide); ++u);
                                return s;
                            },
                            ...
                            moveV: vt(function (r, i) {
                                ...
                                if (
                                    (l.extendSelectionsBy(function (h) {
                                        ...
                                        var k = ca(o, v, r, i);
                                        return (i == "page" && h == l.sel.primary() && ji(o, Zn(o, k, "div").top - v.top), k);
                                    }, Oe),
                                    a.length)
                                )
                            ...
                            scrollIntoView: vt(function (r, i) {
                                (r == null
                                    ? ((r = { from: this.doc.sel.primary().head, to: null }), i == null && (i = this.options.cursorScrollMargin))
                                    : typeof r == "number"
                            ...
                            refresh: vt(function () {
                                ...
                                (bt(this),
                                    ...
                                    Gi(this.display),
                                    (r == null || Math.abs(r - jr(this.display)) > 0.5 || this.options.lineWrapping) && Bi(this),
                                    Ye(this, "refresh", this));
                            }),
                    ...
                    function fo(e, t, n, r, i) {
                        ...
                        function u() {
                            var Q = t.line + s;
                            return Q < e.first || Q >= e.first + e.size ? !1 : ((t = new L(Q, t.ch, t.sticky)), (a = ce(e, Q)));
                        }
                        function h(Q) {
                            var G;
                            if (r == "codepoint") {
                                ...
                                if (isNaN(ee)) G = null;
                                    ...
                                    G = new L(t.line, Math.max(0, Math.min(a.text.length, t.ch + n * (me ? 2 : 1))), -n);
                                }
                        ...
                        if (r == "char" || r == "codepoint") h();
                            ...
                            for (var v = null, k = r == "group", x = e.cm && e.cm.getHelper(t, "wordChars"), M = !0; !(n < 0 && !h(!M)); M = !1) {
                                var E =
                                        a.text.charAt(t.ch) ||
                                        `
`,
...
`
                    ...
                    function ca(e, t, n, r) {
                        var i = e.doc,
                            ...
                            l;
                        if (r == "page") {
                            var a = Math.min(e.display.wrapper.clientHeight, j(e).innerHeight || i(e).documentElement.clientHeight),
                    ...
                    ((je.prototype.init = function (e) {
                        var t = this,
                            ...
                            r = n.cm,
                            i = (n.div = e.lineDiv);
                        ((i.contentEditable = !0), uo(i, r.options.spellcheck, r.options.autocorrect, r.options.autocapitalize));
                        function o(a) {
                        ...
                        function l(a) {
                            if (!(!o(a) || Ze(r, a))) {
                                if (r.somethingSelected())
                                    (hi({ lineWise: !1, text: r.getSelections() }), a.type == "cut" && r.replaceSelection("", null, "cut"));
...
`)));
                                ...
                                (p(v),
                                    setTimeout(function () {
                                        (r.display.lineSpace.removeChild(h), k.focus(), k == i && n.showPrimarySelection());
                                    }, 50));
                            }
                        }
                        ...
                        (je.prototype.showPrimarySelection = function () {
                            ...
                            if (!(o && !o.bad && l && !l.bad && Z(_r(o, l), r) == 0 && Z(xt(o, l), i) == 0)) {
                                var a = t.display.view,
                                    s = (r.line >= t.display.viewFrom && da(t, r)) || { node: a[0].measure.map[2], offset: 0 },
                                ...
                                (x &&
                                    (!I && t.state.focused
                                        ? (e.collapse(s.node, s.offset), x.collapsed || (e.removeAllRanges(), e.addRange(x)))
                        ...
                        (je.prototype.focus = function () {
                            this.cm.options.readOnly != "nocursor" &&
                                ((!this.selectionInEditor() || y(xe(this.div)) != this.div) && this.showSelection(this.prepareSelection(), !0),
                                this.div.focus());
                        }),
                        ...
                        (je.prototype.pollContent = function () {
                            ...
                            var e = this.cm,
                                ...
                                i = n.to();
                            if (
                                (r.ch == 0 && r.line > e.firstLine() && (r = L(r.line - 1, ce(e.doc, r.line - 1).length)),
                                i.ch == ce(e.doc, i.line).text.length && i.line < e.lastLine() && (i = L(i.line + 1, 0)),
                            ...
                            if (
                                ...
                                return !1;
                            for (
                                var v = e.doc.splitLines(Ou(e, a, h, l, u)), k = Vt(e.doc, L(l, 0), L(u, ce(e.doc, u).text.length));
                            ...
                            for (var x = 0, M = 0, E = v[0], R = k[0], U = Math.min(E.length, R.length); x < U && E.charCodeAt(x) == R.charCodeAt(x); ) ++x;
                            for (
                                var Q = ge(v), G = ge(k), ee = Math.min(Q.length - (v.length == 1 ? x : 0), G.length - (k.length == 1 ? x : 0));
                                M < ee && Q.charCodeAt(Q.length - M - 1) == G.charCodeAt(G.length - M - 1);

                            )
                                ++M;
                            if (v.length == 1 && k.length == 1 && l == r.line)
                                for (; x && x > r.ch && Q.charCodeAt(Q.length - M - 1) == G.charCodeAt(G.length - M - 1); ) (x--, M++);
                            ((v[v.length - 1] = Q.slice(0, Q.length - M).replace(/^\u200b+/, "")), (v[0] = v[0].slice(x).replace(/\u200b+$/, "")));
                            var me = L(l, x),
                        ...
                        (je.prototype.onKeyPress = function (e) {
                            e.charCode == 0 ||
                                this.composing ||
                                (e.preventDefault(),
                                this.cm.isReadOnly() || lt(this.cm, so)(this.cm, String.fromCharCode(e.charCode == null ? e.keyCode : e.charCode), 0));
                        }),
                    ...
                    function pi(e, t, n) {
                        ...
                        if (t == e.display.lineDiv) {
                            if (((r = e.display.lineDiv.childNodes[n]), !r)) return rn(e.clipPos(L(e.display.viewTo - 1)), !0);
                            ((t = null), (n = 0));
                        } else
                    ...
                    function Pu(e, t, n) {
                        ...
                        var l = t.nodeType == 3 ? t : null,
                            a = t;
                        for (
                            !l && t.childNodes.length == 1 && t.firstChild.nodeType == 3 && ((l = t.firstChild), n && (n = l.nodeValue.length));
                            a.parentNode != r;
...
`)),
                        ...
                        ($e.prototype.reset = function (e) {
                            if (!(this.contextMenuPending || (this.composing && e))) {
                                ...
                                if (((this.resetting = !0), t.somethingSelected())) {
                                    ...
                                    ((this.textarea.value = n), t.state.focused && p(this.textarea), b && N >= 9 && (this.hasSelection = n));
                                } else e || ((this.prevInput = this.textarea.value = ""), b && N >= 9 && (this.hasSelection = null));
                                this.resetting = !1;
                            }
                        }),
                        ...
                        ($e.prototype.focus = function () {
                            if (this.cm.options.readOnly != "nocursor" && (!ne || y(xe(this.textarea)) != this.textarea))
                                try {
                                    this.textarea.focus();
                                } catch {}
                        }),
                        ...
                        ($e.prototype.poll = function () {
                            ...
                            if ((b && N >= 9 && this.hasSelection === i) || (se && /[\uf700-\uf7ff]/.test(i))) return (t.display.input.reset(), !1);
                            ...
                            ((s.save = r),
                                ...
                                (s.toTextArea = function () {
                                    ((s.toTextArea = isNaN),
                                        ...
                                        (e.style.display = ""),
                                        e.form &&
                                            (dt(e.form, "submit", r), !t.leaveSubmitMethodAlone && typeof e.form.submit == "function" && (e.form.submit = i)));
                                }));
                        }),
                ...
                (function (C) {
                    ...
                    C.defineMode("css", function (fe, H) {
                        ...
                        function Ne(T, B) {
                            ...
                            if (/\d/.test(F) || (F == "." && T.eat(/\d/))) return (T.eatWhile(/[\w.%]/), oe("number", "unit"));
                            if (F === "-") {
                                if (/[\d.]/.test(T.peek())) return (T.eatWhile(/[\w.%]/), oe("number", "unit"));
                                if (T.match(/^-[\w\\\-]*/))
                                    return (
                                        T.eatWhile(/[\w\\\-]/),
                                        T.match(/^\s*:/, !1) ? oe("variable-2", "variable-definition") : oe("variable-2", "variable")
                                    );
                                ...
                                return /[,+>*\/]/.test(F)
                                    ...
                                    : F == "." && T.match(/^-?[_a-z][_a-z0-9-]*/i)
                                      ...
                                      : /[:;{}\[\]\(\)]/.test(F)
                                        ? oe(null, F)
                                        : T.match(/^[\w-.]+(?=\()/)
                                          ? (/^(url(-prefix)?|domain|regexp)$/i.test(T.current()) && (B.tokenize = Ve), oe("variable callee", "variable"))
                                          : /[\w\\\-]/.test(F)
                        ...
                        function Ve(T, B) {
                            return (T.next(), T.match(/^\s*[\"\')]/, !1) ? (B.tokenize = null) : (B.tokenize = qe(")")), oe(null, "("));
                        }
                        function ct(T, B, F) {
                        ...
                        function ge(T) {
                            ...
                            Y.hasOwnProperty(B) ? (be = "atom") : c.hasOwnProperty(B) ? (be = "keyword") : (be = "variable");
                        }
                        var Pe = {};
                        return (
                            (Pe.top = function (T, B, F) {
                                ...
                                if (/^@(media|supports|(-moz-)?document|import)$/i.test(T)) return Oe(F, B, "atBlock");
                                if (/^@(font-face|counter-style)/i.test(T)) return ((F.stateArg = T), "restricted_atBlock_before");
                                    ...
                                    return y.hasOwnProperty(Ie)
                                        ...
                                        : P.hasOwnProperty(Ie)
                                          ...
                                          : xe
                                            ...
                                            : ((be += " error"), "maybeprop");
                                } else return T == "meta" ? "block" : !xe && (T == "hash" || T == "qualifier") ? ((be = "error"), "block") : Pe.top(T, B, F);
                            }),
                            ...
                            (Pe.prop = function (T, B, F) {
                                ...
                                if (T == "hash" && !/^#([0-9a-fA-F]{3,4}|[0-9a-fA-F]{6}|[0-9a-fA-F]{8})$/.test(B.current())) be += " error";
                                else if (T == "word") ge(B);
                                else if (T == "interpolation") return Oe(F, B, "interpolation");
                                return "prop";
                            }),
                            (Pe.propBlock = function (T, B, F) {
                                return T == "}" ? Re(F) : T == "word" ? ((be = "property"), "maybeprop") : F.context.type;
                            }),
                            ...
                            (Pe.pseudo = function (T, B, F) {
                                return T == "meta" ? "pseudo" : T == "word" ? ((be = "variable-3"), F.context.type) : Ue(T, B, F);
                            }),
                            (Pe.documentTypes = function (T, B, F) {
                                return T == "word" && d.hasOwnProperty(B.current()) ? ((be = "tag"), F.context.type) : Pe.atBlock(T, B, F);
                            }),
                            ...
                            (Pe.atBlock_parens = function (T, B, F) {
                                return T == ")" ? Re(F) : T == "{" || T == "}" ? et(T, B, F, 2) : Pe.atBlock(T, B, F);
                            }),
                            ...
                            (Pe.restricted_atBlock = function (T, B, F) {
                                return T == "}"
                                    ...
                                    : T == "word"
                                      ? ((F.stateArg == "@font-face" && !le.hasOwnProperty(B.current().toLowerCase())) ||
                            ...
                            (Pe.keyframes = function (T, B, F) {
                                return T == "word" ? ((be = "variable"), "keyframes") : T == "{" ? Oe(F, B, "top") : Ue(T, B, F);
                            }),
                            ...
                            (Pe.interpolation = function (T, B, F) {
                                return T == "}"
                                    ...
                                    : T == "{" || T == ";"
                                      ? et(T, B, F)
                                      : (T == "word" ? (be = "variable") : T != "variable" && T != "(" && T != ")" && (be = "error"), "interpolation");
                            }),
                            {
                                startState: function (T) {
                                    return { tokenize: null, state: Ee ? "block" : "top", stateArg: null, context: new ct(Ee ? "block" : "top", T || 0, null) };
                                },
                                token: function (T, B) {
                                ...
                                indent: function (T, B) {
                                    ...
                                    return (
                                        ...
                                        F.prev &&
                                            (Ie == "}" && (F.type == "block" || F.type == "top" || F.type == "interpolation" || F.type == "restricted_atBlock")
                    ...
                    var I = ["domain", "regexp", "url", "url-prefix"],
                        ...
                        we = De(ke),
                        te = ["additive-symbols", "fallback", "negative", "pad", "prefix", "range", "speak-as", "suffix", "symbols", "system"],
                        re = De(te),
                        ne = [
                            "aliceblue",
                            "antiquewhite",
                    ...
                    (C.defineMIME("text/css", {
                        ...
                        C.defineMIME("text/x-scss", {
                            ...
                            tokenHooks: {
                                ...
                                $: function (fe) {
                                    return (fe.match(/^[\w-]+/), fe.match(/^\s*:/, !1) ? ["variable-2", "variable-definition"] : ["variable-2", "variable"]);
                                },
                                "#": function (fe) {
                        ...
                        C.defineMIME("text/x-less", {
                            ...
                            tokenHooks: {
                                ...
                                "@": function (fe) {
                                    return fe.eat("{")
                                        ? [null, "interpolation"]
                                        : fe.match(/^(charset|document|font-face|import|(-(moz|ms|o|webkit)-)?keyframes|media|namespace|page|supports)\b/i, !1)
                                          ? !1
                                          : (fe.eatWhile(/[\w\\\-]/),
                                            fe.match(/^\s*:/, !1) ? ["variable-2", "variable-definition"] : ["variable-2", "variable"]);
                                },
                                "&": function () {
                                    return ["atom", "atom"];
                                }
            ...
            (function (Et, zt) {
                (function (C) {
                    ...
                    (C.defineMode("xml", function (K, $) {
                        ...
                        function z(d, S) {
                            var w = d.next();
                            if (w == ">" || (w == "/" && d.eat(">"))) return ((S.tokenize = q), (ie = w == ">" ? "endTag" : "selfcloseTag"), "tag bracket");
                        ...
                        function re(d, S, w) {
                            ((this.prev = d.context),
                                ...
                                (this.startOfLine = w),
                                (b.doNotIndent.hasOwnProperty(S) || (d.context && d.context.noIndent)) && (this.noIndent = !0));
                        }
                        function ne(d) {
                        ...
                        function se(d, S) {
                            for (var w; ; ) {
                                if (
                                    !d.context ||
                                    ((w = d.context.tagName), !b.contextGrabbers.hasOwnProperty(te(w)) || !b.contextGrabbers[te(w)].hasOwnProperty(te(S)))
                                )
                                    return;
                                ne(d);
                            }
                        ...
                        function de(d, S, w) {
                            if (d == "word") {
                                var m = S.current();
                                return (
                                    w.context && w.context.tagName != m && b.implicitlyClosed.hasOwnProperty(te(w.context.tagName)) && ne(w),
                                    (w.context && w.context.tagName == m) || b.matchClosing === !1 ? ((O = "tag"), ze) : ((O = "tag error"), fe)
                                );
                        ...
                        function D(d, S, w) {
                            return d == "string" ? J : d == "word" && b.allowUnquoted ? ((O = "string"), H) : ((O = "error"), H(d, S, w));
                        }
                        function J(d, S, w) {
                        ...
                        return {
                            startState: function (d) {
                                var S = { tokenize: q, state: Ae, indented: d || 0, tagName: null, tagStart: null, context: null };
                                return (d != null && (S.baseIndent = d), S);
                            },
                            token: function (d, S) {
                                if ((!S.tagName && d.sol() && (S.indented = d.indentation()), d.eatSpace())) return null;
                                ie = null;
                                var w = S.tokenize(d, S);
                                return (
                                    (w || ie) && w != "comment" && ((O = null), (S.state = S.state(ie || w, d, S)), O && (w = O == "error" ? w + " error" : O)),
                                    w
                                );
                            },
                            indent: function (d, S, w) {
                                var m = d.context;
                                if (d.tokenize.isInAttribute) return d.tagStart == d.indented ? d.stringStartCol + 1 : d.indented + V;
                        ...
                        C.mimeModes.hasOwnProperty("text/html") || C.defineMIME("text/html", { name: "xml", htmlMode: !0 }));
                });
            })()),
        ma.exports
    );
                ...
                (function (C) {
                    ...
                    (C.defineMode("javascript", function (De, I) {
                        var K = De.indentUnit,
                            ...
                            q = /[+\-*&%=<>!?|~^@]/,
                            z = /^@(context|id|value|language|type|container|list|set|reverse|index|base|vocab|graph)"/;
                        function X(f) {
                        ...
                        function re(f, g) {
                            ...
                            if (A == "." && f.match(/^\d[\d_]*(?:[eE][+\-]?[\d_]+)?/)) return te("number", "number");
                            if (A == "." && f.match("..")) return te("spread", "meta");
                            if (/[\[\]{}\(\),;\:\.]/.test(A)) return te(A);
                            if (A == "=" && f.eat(">")) return te("=>", "operator");
                            if (A == "0" && f.match(/^(?:x[\dA-Fa-f_]+|o[0-7_]+|b[01_]+)n?/)) return te("number", "number");
                            if (/\d/.test(A)) return (f.match(/^[\d_]*(?:n|(?:\.[\d_]*)?(?:[eE][+\-]?[\d_]+)?)?/), te("number", "number"));
                            if (A == "/")
                                return f.eat("*")
                            ...
                            if ((A == "<" && f.match("!--")) || (A == "-" && f.match("->") && !/\S/.test(f.string.slice(0, f.start))))
                                return (f.skipToEnd(), te("comment", "comment"));
                            if (q.test(A))
                                return (
                                    (A != ">" || !g.lexical || g.lexical.type != ">") &&
                                        (f.eat("=") ? (A == "!" || A == "=") && f.eat("=") : /[<>*+\-|&?]/.test(A) && (f.eat(A), A == ">" && f.eat(A))),
                            ...
                            if (ie.test(A)) {
                                ...
                                if (g.lastType != ".") {
                                    ...
                                    if (W == "async" && f.match(/^(\s|\/\*([^*]|\*(?!\/))*?\*\/)*[\[\(\w]/, !1)) return te("async", "keyword", W);
                                }
                        ...
                        function ne(f) {
                            return function (g, A) {
                                var W = !1,
                                    L;
                                if (V && g.peek() == "@" && g.match(z)) return ((A.tokenize = re), te("jsonld-keyword", "meta"));
                        ...
                        function de(f, g) {
                            ...
                            if (!(A < 0)) {
                                if (_) {
                                    var W = /:\s*(?:\w+(?:<[^>]*>|\[\])?|\{[^}]*\})\s*$/.exec(f.string.slice(f.start, A));
                                    W && (A = W.index);
                                }
                        ...
                        var ze = { atom: !0, number: !0, variable: !0, string: !0, regexp: !0, this: !0, import: !0, "jsonld-keyword": !0 };
                        function fe(f, g, A, W, L, Z) {
                            ((this.indented = f), (this.column = g), (this.type = A), (this.prev = L), (this.info = Z), W != null && (this.align = W));
                        }
                        function H(f, g) {
                            if (!N) return !1;
                        ...
                        function Ee(f, g, A, W, L) {
                            var Z = f.cc;
                            for (
                                D.state = f, D.stream = L, D.marked = null, D.cc = Z, D.style = g, f.lexical.hasOwnProperty("align") || (f.lexical.align = !0);
                                ;
                        ...
                        function c() {
                            ((D.state.context = new P(D.state.context, D.state.localVars, !1)), (D.state.localVars = p));
                        }
                        function Y() {
                            ((D.state.context = new P(D.state.context, D.state.localVars, !0)), (D.state.localVars = null));
                        }
                        c.lex = Y.lex = !0;
                        function xe() {
                        ...
                        function j(f, g) {
                            var A = function () {
                                ...
                                else for (var Z = W.lexical; Z && Z.type == ")" && Z.align; Z = Z.prev) L = Z.indented;
                                      ...
                                      : f == "debugger"
                                        ...
                                        : f == "{"
                                          ...
                                          : f == ";"
                                            ? d()
                                            : f == "if"
                                              ? (D.state.lexical.info == "else" && D.state.cc[D.state.cc.length - 1] == ue && D.state.cc.pop()(),
                                                  ...
                                                  : f == "class" || (_ && g == "interface")
                                                    ...
                                                    : f == "variable"
                                                      ? _ && g == "declare"
                                                          ...
                                                          : _ && (g == "module" || g == "enum" || g == "type") && D.stream.match(/^\s*\w/, !1)
                                                            ? ((D.marked = "keyword"),
                                                              g == "enum"
                                                                  ? d(ce)
                                                                  : g == "type"
                        ...
                        function Re(f, g, A) {
                            ...
                            if (f != ";") {
                                ...
                                if (f == "regexp")
                                    return ((D.state.lastType = D.marked = "operator"), D.stream.backUp(D.stream.pos - D.stream.start - 1), d(L));
                            }
                        }
                        function Ue(f, g) {
                        ...
                        function T(f) {
                            return function (g) {
                                return g == "." ? d(f ? F : B) : g == "variable" && _ ? d(Ct, f ? Re : Oe) : J(f ? Ne : oe);
                            };
                        }
                        function B(f, g) {
                        ...
                        function Se(f, g) {
                            ...
                            if (f == "variable" || D.style == "keyword") {
                                ...
                                if (f == "number" || f == "string") return ((D.marked = V ? "property" : D.style + " property"), d(Be));
                        ...
                        function We(f, g) {
                            if (g == "keyof" || g == "typeof" || g == "infer" || g == "readonly") return ((D.marked = "keyword"), d(g == "typeof" ? Ne : We));
                        ...
                        function Ze(f, g) {
                            return (f == "variable" && D.stream.match(/^\s*[?:]/, !1)) || g == "?" ? d(Ze) : f == ":" ? d(We) : f == "spread" ? d(Ze) : J(We);
                        }
                        function Ot(f, g) {
                        ...
                        function ar(f, g) {
                            return f == "variable" && !D.stream.match(/^\s*:/, !1)
                                ...
                                : (f == "variable" && (D.marked = "property"),
                                  f == "spread" ? d(yt) : f == "}" ? J() : f == "[" ? d(oe, Te("]"), Te(":"), ar) : d(Te(":"), yt, Wt));
                        }
                        function ln() {
                            return J(yt, Wt);
                        }
                        ...
                        function sr(f, g) {
                            return f == ")" ? d() : f == ";" ? d(sr) : g == "in" || g == "of" ? ((D.marked = "keyword"), d(oe, sr)) : J(oe, sr);
                        }
                        function Pt(f, g) {
                        ...
                        function _t(f, g) {
                            return (
                                g == "@" && d(oe, _t),
                                f == "spread" ? d(_t) : _ && y(g) ? ((D.marked = "keyword"), d(_t)) : _ && f == "this" ? d(or, Wt) : J(yt, or, Wt)
                            );
                        }
                        function xi(f, g) {
                        ...
                        function Rt(f, g) {
                            if (
                                f == "async" ||
                                (f == "variable" && (g == "static" || g == "get" || g == "set" || (_ && y(g))) && D.stream.match(/^\s+#?[\w$\xa1-\uffff]/, !1))
                            )
                        ...
                        function Br(f, g) {
                            return f == "{" ? Lt(Br, "}") : (f == "variable" && w(g), g == "*" && (D.marked = "keyword"), d(sn));
                        }
                        function Gt(f) {
                            if (f == ",") return d(Br, Gt);
                        }
                        ...
                        function un(f, g) {
                            return f.lastType == "operator" || f.lastType == "," || q.test(g.charAt(0)) || /[,.]/.test(g.charAt(0));
                        }
                        function Ft(f, g, A) {
                            return (
                                (g.tokenize == re && /^(?:operator|sof|keyword [bcd]|case|new|export|default|spread|[\[{}\(,;:]|=>)$/.test(g.lastType)) ||
                        ...
                        return {
                            startState: function (f) {
                                ...
                                return (I.globalVars && typeof I.globalVars == "object" && (g.globalVars = I.globalVars), g);
                            },
                            token: function (f, g) {
                                if (
                                    (f.sol() && (g.lexical.hasOwnProperty("align") || (g.lexical.align = !1), (g.indented = f.indentation()), de(f, g)),
                                ...
                                return ke == "comment"
                                    ? A
                                    : ((g.lastType = ke == "operator" && (we == "++" || we == "--") ? "incdec" : ke), Ee(g, A, ke, we, f));
                            },
                            indent: function (f, g) {
                                ...
                                for (
                                    ...
                                    (A == "}" || ((L = f.cc[f.cc.length - 1]) && (L == Oe || L == Re) && !/^[,\.=+\-*:?[\(]/.test(g)));
                                ...
                                var it = W.type,
                                    xt = A == it;
                                return it == "vardef"
                                    ? W.indented + (f.lastType == "operator" || f.lastType == "," ? W.info.length + 1 : 0)
                                    : it == "form" && A == "{"
                                      ? W.indented
                                      : it == "form"
                                        ? W.indented + K
            ...
            (function (Et, zt) {
                (function (C) {
                    ...
                    function I(ie, O, q) {
                        var z = ie.current(),
                            X = z.search(O);
                        return (X > -1 ? ie.backUp(z.length - X) : z.match(/<\/?$/) && (ie.backUp(z.length), ie.match(O, !1) || ie.match(z)), q);
                    }
                    var K = {};
                    function $(ie) {
                        var O = K[ie];
                    ...
                    function N(ie, O) {
                        for (var q in ie) for (var z = O[q] || (O[q] = []), X = ie[q], ke = X.length - 1; ke >= 0; ke--) z.unshift(X[ke]);
                    }
                    function _(ie, O) {
                    ...
                    (C.defineMode(
                        ...
                        function (ie, O) {
                            ...
                            if ((N(De, z), X && N(X, z), ke))
                                for (var we = ke.length - 1; we >= 0; we--) z.script.unshift(["type", ke[we].matches, ke[we].mode]);
                            function te(re, ne) {
                            ...
                            return {
                                startState: function () {
                                    ...
                                    return { token: te, inTag: null, localMode: null, localState: null, htmlState: re };
                                },
                                copyState: function (re) {
                                    var ne;
                                    return (
                                        re.localState && (ne = C.copyState(re.localMode, re.localState)),
                                        { token: re.token, inTag: re.inTag, localMode: re.localMode, localState: ne, htmlState: C.copyState(q, re.htmlState) }
                                    );
                                },
                ...
                (function (C) {
                    ...
                    (C.defineMode("python", function (N, _) {
                        ...
                        var X = _.hangingIndent || N.indentUnit,
                            ke = K,
                            we = $;
                        (_.extra_keywords != null && (ke = ke.concat(_.extra_keywords)), _.extra_builtins != null && (we = we.concat(_.extra_builtins)));
                        var te = !(_.version && Number(_.version) < 3);
                        if (te) {
                            var re = _.identifiers || /^[_A-Za-z\u00A1-\uFFFF][_A-Za-z0-9\u00A1-\uFFFF]*/;
                            ((ke = ke.concat(["nonlocal", "None", "aiter", "anext", "async", "await", "breakpoint", "match", "case"])),
                        ...
                        function ye(S, w) {
                            ...
                            if ((m && (w.indent = S.indentation()), m && V(w).type == "py")) {
                                ...
                                if (S.eatSpace()) {
                                    var P = S.indentation();
                                    return (P > y ? H(w) : P < y && D(S, w) && S.peek() != "#" && (w.errorToken = !0), null);
                                } else {
                                    var le = de(S, w);
                        ...
                        function de(S, w, m) {
                            ...
                            if (S.match(/^[0-9\.]/, !1)) {
                                var y = !1;
                                if ((S.match(/^[\d_]*\.\d+(e[\+\-]?\d+)?/i) && (y = !0), S.match(/^[\d_]+\.\d*/) && (y = !0), S.match(/^\.\d+/) && (y = !0), y))
                                ...
                                return function (c, Y) {
                                    ...
                                    return (
                                        xe == "punctuation" &&
                                            (c.current() == "{"
                                                ? (Y.tokenize = P(p + 1))
                                                : c.current() == "}" && (p > 1 ? (Y.tokenize = P(p - 1)) : (Y.tokenize = le))),
                                        xe
                                    );
                                };
                            }
                            function le(p, c) {
                                for (; !p.eol(); )
                                    if ((p.eatWhile(/[^'"\{\}\\]/), p.eat("\\"))) {
                                        ...
                                        if (p.match("{{")) return y;
                                        if (p.match("{", !1)) return ((c.tokenize = P(0)), p.current() ? y : c.tokenize(p, c));
                                        if (p.match("}}")) return y;
                        ...
                        function J(S, w) {
                            ...
                            var m = w.tokenize(S, w),
                                y = S.current();
                            if (w.beginningOfLine && y == "@") return S.match(re, !1) ? "meta" : te ? "operator" : ie;
                            if (
                            ...
                            return (w.dedent && S.eol() && V(w).type == "py" && w.scopes.length > 1 && w.scopes.pop(), m);
                        }
                        var d = {
                            ...
                            token: function (S, w) {
                                ...
                                var y = J(S, w);
                                return (
                                    y && y != "comment" && (w.lastToken = y == "keyword" || y == "punctuation" ? S.current() : y),
                            ...
                            indent: function (S, w) {
                                ...
                                var m = V(S),
                                    y = m.type == w.charAt(0) || (m.type == "py" && !S.dedent && /^(else:|elif |except |finally:)/.test(w));
            ...
            (function (Et, zt) {
                (function (C) {
                    ...
                    function De(m, y, P, le, p, c) {
                        ((this.indented = m), (this.column = y), (this.type = P), (this.info = le), (this.align = p), (this.prev = c));
                    }
                    function I(m, y, P, le) {
                        var p = m.indented;
                        return (
                            m.context && m.context.type == "statement" && P != "statement" && (p = m.context.indented),
                            (m.context = new De(p, y, P, le, null, m.context))
                        );
                    }
                    function K(m) {
                        var y = m.context.type;
                        return ((y == ")" || y == "]" || y == "}") && (m.indented = m.context.indented), (m.context = m.context.prev));
                    }
                    function $(m, y, P) {
                        if (
                    ...
                    C.defineMode("clike", function (m, y) {
                        var P = m.indentUnit,
                            ...
                            ct = y.numberStart || /[\d\.]/,
                            Oe = y.number || /^(?:0x[a-f\d]+|0b[01]+|(?:\d+\.?\d*|\.\d+)(?:e[-+]?\d+)?)(u|ll?|l|f)?/i,
                            Re = y.isOperatorChar || /[+\-*&%=<>!?|\/]/,
                        ...
                        function Ie(ae, Se) {
                            y.typeFirstDefinitions && ae.eol() && V(Se.context) && (Se.typeAtEndOfLine = $(ae, Se, ae.pos));
                        }
                        return {
                            startState: function (ae) {
                                return { tokenize: null, context: new De((ae || 0) - P, 0, "top", null, !1), indented: 0, startOfLine: !0, prevToken: null };
                            },
                            token: function (ae, Se) {
                                var he = Se.context;
                                if ((ae.sol() && (he.align == null && (he.align = !1), (Se.indented = ae.indentation()), (Se.startOfLine = !0)), ae.eatSpace()))
                                    return (Ie(ae, Se), null);
                                ge = Pe = null;
                                var Be = (Se.tokenize || T)(ae, Se);
                                if (Be == "comment" || Be == "meta") return Be;
                                if ((he.align == null && (he.align = !0), ge == ";" || ge == ":" || (ge == "," && ae.match(/^\s*(?:\/\/.*)?$/, !1))))
                                    ...
                                    ge == he.type
                                        ? K(Se)
                                        : oe &&
                                          (((he.type == "}" || he.type == "top") && ge != ";") || (he.type == "statement" && ge == "newstatement")) &&
                                          I(Se, ae.column(), "statement", ae.current());
                                if (
                                    (Be == "variable" &&
                                        (Se.prevToken == "def" || (y.typeFirstDefinitions && $(ae, Se, ae.start) && V(Se.context) && ae.match(/^\s*\(/, !1))) &&
                                        (Be = "def"),
                                    Le.token)
                                ) {
                            ...
                            indent: function (ae, Se) {
                                if ((ae.tokenize != T && ae.tokenize != null) || (ae.typeAtEndOfLine && V(ae.context))) return C.Pass;
                                var he = ae.context,
                                    Be = Se && Se.charAt(0),
                                    Me = Be == he.type;
                                if ((he.type == "statement" && Be == "}" && (he = he.prev), y.dontIndentStatements))
                                    for (; he.type == "statement" && y.dontIndentStatements.test(he.info); ) he = he.prev;
                                if (Le.indent) {
                                ...
                                return he.type == "statement"
                                    ...
                                    : he.align && (!p || he.type != ")")
                                      ...
                                      : he.type == ")" && !Me
                                        ? he.indented + le
                                        : he.indented + (Me ? 0 : P) + (!Me && Nt && !/^(?:case|default)\b/.test(Se) ? P : 0);
                            },
                    ...
                    function Ae(m) {
                        return !m || m.length < 2 || m[0] != "_" ? !1 : m[1] == "_" || m[1] !== m[1].toLowerCase();
                    }
                    function ye(m) {
                    ...
                    function de(m, y) {
                        ...
                        return m.match(/^(?:u8|u|U|L)/) ? (m.match(/^["']/, !1) ? "string" : !1) : (m.next(), !1);
                    }
                    function ze(m) {
                        var y = /(\w+)::~?(\w+)$/.exec(m);
                        return y && y[1] == y[2];
                    ...
                    function Ee(m, y) {
                        ...
                        (le(y.keywords), le(y.types), le(y.builtin), le(y.atoms), P.length && ((y.helperType = m[0]), C.registerHelper("hintWords", m[0], P)));
                    ...
                    (Ee(["text/x-csrc", "text/x-c", "text/x-chdr"], {
                        ...
                        Ee("text/x-csharp", {
                            ...
                            hooks: {
                                "@": function (m, y) {
                                    return m.eat('"') ? ((y.tokenize = fe), fe(m, y)) : (m.eatWhile(/[\w\$_]/), "meta");
                                }
                            }
                        }));
                    function D(m, y) {
                    ...
                    Ee("text/x-scala", {
                        ...
                        multiLineStrings: !0,
                        blockKeywords: b("catch class enum do else finally for forSome if match switch try while"),
                        ...
                        hooks: {
                            ...
                            "'": function (m) {
                                return m.match(/^(\\[^'\s]+|[^\\'])'/) ? "string-2" : (m.eatWhile(/[\w\$_\xa1-\uffff]/), "atom");
                            },
                            "=": function (m, y) {
                                var P = y.context;
                                return P.type == "}" && P.align && m.eat(">")
                                    ? ((y.context = new De(P.indented, P.column, P.type, P.info, null, P.prev)), "operator")
                                    : !1;
                            },
                            "/": function (m, y) {
                    ...
                    function d(m) {
                        return function (y, P) {
                            for (var le = !1, p, c = !1; !y.eol(); ) {
                                ...
                                ((p = y.next()), !le && p == "$" && y.match("{") && y.skipTo("}"), (le = !le && p == "\\" && !m));
                            }
                    ...
                    (Ee("text/x-kotlin", {
                        ...
                        hooks: {
                            ...
                            indent: function (m, y, P, le) {
                                ...
                                if (y.align && y.type == "}") return y.indented + (m.context.type == (P || "").charAt(0) ? 0 : le);
                            }
                        },
                        ...
                        Ee("text/x-objectivec", {
                            ...
                            types: we,
                            builtin: b(q),
                            blockKeywords: b(te + " @synthesize @try @catch @finally @autoreleasepool @synchronized"),
                        ...
                        Ee("text/x-objectivec++", {
                            ...
                            types: we,
                            builtin: b(q),
                            blockKeywords: b(te + " @synthesize @try @catch @finally @autoreleasepool @synchronized class try catch"),
                    ...
                    Ee("text/x-ceylon", {
                        ...
                        blockKeywords: b("case catch class dynamic else finally for function if interface module new object switch try while"),
                    ...
                    ((C.findModeByMIME = function (K) {
                        ...
                        (C.findModeByName = function (K) {
                            ...
                            for (var $ = 0; $ < C.modeInfo.length; $++) {
                                ...
                                if (V.alias) {
                                    for (var b = 0; b < V.alias.length; b++) if (V.alias[b].toLowerCase() == K) return V;
                                }
                            }
                        }));
                });
                    ...
                    (C.defineMode(
                        ...
                        function (De, I) {
                            ...
                            (I.highlightFormatting === void 0 && (I.highlightFormatting = !1),
                                ...
                                I.fencedCodeBlockDefaultMode === void 0 && (I.fencedCodeBlockDefaultMode = "text/plain"),
                            ...
                            for (var N in b) b.hasOwnProperty(N) && I.tokenTypeOverrides[N] && (b[N] = I.tokenTypeOverrides[N]);
                            var _ = /^([*\-_])(?:\s*\1){2,}\s*$/,
                                ie = /^(?:[*\-+]|^[0-9]+([.)]))\s+/,
                                O = /^\[(x| )\](?=\s)/i,
                            ...
                            function ye(p) {
                                if (
                                    ...
                                    if (!c) {
                                        ...
                                        c = Y.mode.name == "xml" && Y.state.tagStart === null && !Y.state.context && Y.state.tokenize.isInText;
                                    }
                                    c && ((p.f = D), (p.block = de), (p.htmlState = null));
                                }
                                return ((p.trailingSpace = 0), (p.trailingSpaceNewLine = !1), (p.prevLine = p.thisLine), (p.thisLine = { stream: null }), null);
                            }
                            function de(p, c) {
                                ...
                                var oe = !xe && !ue && !c.prevLine.header && (!Te || !j) && !c.prevLine.fencedCodeEnd,
                                    Ne = (c.list === !1 || ue || xe) && c.indentation <= Le && p.match(_),
                                    qe = null;
                                if (c.indentationDiff >= 4 && (j || c.prevLine.fencedCodeEnd || c.prevLine.header || xe))
                                ...
                                if (c.indentation <= Le && p.eat(">"))
                                    return ((c.quote = Y ? 1 : c.quote + 1), I.highlightFormatting && (c.formatting = "quote"), p.eatSpace(), H(c));
                                if (!Ne && !c.setext && Y && c.indentation <= Le && (qe = p.match(ie))) {
                                    ...
                                    if (Y && c.indentation <= Le && (qe = p.match(ke, !0)))
                                        return (
                                            ...
                                            (c.localMode = I.fencedCodeBlockHighlighting && V(qe[2] || I.fencedCodeBlockDefaultMode)),
                                    ...
                                    if (
                                        ...
                                        return (
                                            c.setext
                                                ? ((c.header = c.setext), (c.setext = 0), p.skipToEnd(), I.highlightFormatting && (c.formatting = "header"))
                            ...
                            function ze(p, c) {
                                ...
                                if (!$) {
                                    ...
                                    ((xe.mode.name == "xml" && xe.state.tagStart === null && !xe.state.context && xe.state.tokenize.isInText) ||
                            ...
                            function fe(p, c) {
                                ...
                                } else return c.localMode ? c.localMode.token(p, c.localState) : (p.skipToEnd(), b.code);
                            }
                            function H(p) {
                                var c = [];
                                if (p.formatting) {
                                    (c.push(b.formatting), typeof p.formatting == "string" && (p.formatting = [p.formatting]));
                                    for (var Y = 0; Y < p.formatting.length; Y++)
                                        (c.push(b.formatting + "-" + p.formatting[Y]),
                                            p.formatting[Y] === "header" && c.push(b.formatting + "-" + p.formatting[Y] + "-" + p.header),
                                ...
                                return (
                                    p.trailingSpaceNewLine
                                        ...
                                        : p.trailingSpace && c.push("trailing-space-" + (p.trailingSpace % 2 ? "a" : "b")),
                            ...
                            function D(p, c) {
                                ...
                                if (j === "!" && p.match(/\[[^\]]*\] ?(?:\(|\[)/, !1))
                                    return ((c.imageMarker = !0), (c.image = !0), I.highlightFormatting && (c.formatting = "image"), H(c));
                                if (j === "[" && c.imageMarker && p.match(/[^\]]*\](\(.*?\)| ?\[.*?\])/, !1))
                                    return ((c.imageMarker = !1), (c.imageAltText = !0), I.highlightFormatting && (c.formatting = "image"), H(c));
                                if (j === "]" && c.imageAltText) {
                                ...
                                if (j === "[" && !c.image)
                                    return ((c.linkText && p.match(/^.*?\]/)) || ((c.linkText = !0), I.highlightFormatting && (c.formatting = "link")), H(c));
                                if (j === "]" && c.linkText) {
                                    I.highlightFormatting && (c.formatting = "link");
                                    var Ne = H(c);
                                    return ((c.linkText = !1), (c.inline = c.f = p.match(/\(.*?\)| ?\[.*?\]/, !1) ? d : D), Ne);
                                }
                                ...
                                if (I.xml && j === "<" && p.match(/^(!--|\?|!\[CDATA\[|[a-z][a-z0-9-]*(?:\s+[a-z_:.\-]+(?:\s*=\s*[^>]+)?)*\s*(?:>|$))/i, !1)) {
                                ...
                                if (j === "*" || j === "_") {
                                    for (var Oe = 1, Re = p.pos == 1 ? " " : p.string.charAt(p.pos - 2); Oe < 3 && p.eat(j); ) Oe++;
                                    var Ue = p.peek() || " ",
                                    ...
                                    if (
                                        ...
                                        (I.highlightFormatting && (c.formatting = Pe == null ? "strong" : T == null ? "em" : "strong em"),
                                            Pe === !0 && (c.em = j),
                                            T === !0 && (c.strong = j));
                                        var oe = H(c);
                                ...
                                if (I.strikethrough) {
                                    if (j === "~" && p.eatWhile(j)) {
                                        if (c.strikethrough) {
                                            ...
                                            return ((c.strikethrough = !0), I.highlightFormatting && (c.formatting = "strikethrough"), H(c));
                                    } else if (j === " " && p.match("~~", !0)) {
                                        if (p.peek() === " ") return H(c);
                                        p.backUp(2);
                                    }
                                }
                                if (I.emoji && j === ":" && p.match(/^(?:[a-z_\d+][a-z_\d+-]*|\-[a-z_\d+][a-z_\d+-]*):/)) {
                                    ((c.emoji = !0), I.highlightFormatting && (c.formatting = "emoji"));
                                    var B = H(c);
                                    return ((c.emoji = !1), B);
                                }
                                return (j === " " && (p.match(/^ +$/, !1) ? c.trailingSpace++ : c.trailingSpace && (c.trailingSpaceNewLine = !0)), H(c));
                            }
                            function J(p, c) {
                                var Y = p.next();
                                if (Y === ">") {
                            ...
                            function m(p, c) {
                                return p.match(/^([^\]\\]|\\.)*\]:/, !1)
                                    ? ((c.f = y), p.next(), I.highlightFormatting && (c.formatting = "link"), (c.linkText = !0), H(c))
                                    : ne(p, c, D);
                            }
                            function y(p, c) {
                                if (p.match("]:", !0)) {
                ...
                (function (C) {
                    ...
                    function K(N) {
                        setTimeout(function () {
                            ...
                            if (N.lineCount() == 1) {
                                ...
                                _ = ie.nodeName == "TEXTAREA" ? !N.getLine(0).length : !/[^\u200b]/.test(ie.querySelector(".CodeMirror-line").textContent);
                            }
                            _ ? I(N) : De(N);
                        }, 20);
                    }
                    ...
                    function V(N) {
                        var _ = N.getWrapperElement(),
                            ie = b(N);
                        ((_.className = _.className.replace(" CodeMirror-empty", "") + (ie ? " CodeMirror-empty" : "")), ie ? I(N) : De(N));
                    }
                    function b(N) {
                ...
                (function (C) {
                    ...
                    ((C.defineSimpleMode = function (O, q) {
                        ...
                        (C.simpleMode = function (O, q) {
                            ...
                            var Ae = {
                                startState: function () {
                                    return { state: "start", pending: null, local: null, localState: null, indent: ke ? [] : null };
                                },
                                copyState: function (de) {
                                    ...
                                    (de.localState && (ze.localState = C.copyState(de.local.mode, de.localState)), de.stack && (ze.stack = de.stack.slice(0)));
                                    for (var fe = de.persistentStates; fe; fe = fe.next)
                                        ze.persistentStates = {
                                            mode: fe.mode,
                                            spec: fe.spec,
                                            state: fe.state == de.localState ? ze.localState : C.copyState(fe.mode, fe.state),
                    ...
                    function I(O, q) {
                        ...
                        var z = "";
                        return (
                            O instanceof RegExp ? (O.ignoreCase && (z = "i"), O.unicode && (z += "u"), (O = O.source)) : (O = String(O)),
                            new RegExp((q === !1 ? "" : "^") + "(?:" + O + ")", z)
                        );
                    }
                    function K(O) {
                    ...
                    function $(O, q) {
                        ((O.next || O.push) && De(q, O.next || O.push), (this.regex = I(O.regex)), (this.token = K(O.token)), (this.data = O));
                    }
                    function V(O, q) {
                        return function (z, X) {
                            if (X.pending) {
                                var ke = X.pending.shift();
                                return (X.pending.length == 0 && (X.pending = null), (z.pos += ke.text.length), ke.token);
                            }
                            if (X.local)
                                if (X.local.end && z.match(X.local.end)) {
                                    ...
                                    var we = X.local.mode.token(z, X.localState),
                                        te;
                                    return (X.local.endScan && (te = X.local.endScan.exec(z.current())) && (z.pos = z.start + te.index), we);
                                }
                            for (var re = O[X.state], ne = 0; ne < re.length; ne++) {
                                ...
                                if (Ae) {
                                    ...
                                    var ye = se.token;
                                    if ((ye && ye.apply && (ye = ye(Ae)), Ae.length > 2 && se.token && typeof se.token != "string")) {
                                        for (var de = 2; de < Ae.length; de++)
                                            Ae[de] && (X.pending || (X.pending = [])).push({ text: Ae[de], token: se.token[de - 1] });
                    ...
                    function N(O, q, z, X) {
                        var ke;
                        if (z.persistent)
                            for (var we = q.persistentStates; we && !ke; we = we.next) (z.spec ? b(z.spec, we.spec) : z.mode == we.mode) && (ke = we);
                        var te = ke ? ke.mode : z.mode || C.getMode(O, z.spec),
                            re = ke ? ke.state : C.startState(te);
                        (z.persistent && !ke && (q.persistentStates = { mode: te, spec: z.spec, state: re, next: q.persistentStates }),
                            (q.localState = re),
                            (q.local = {
                                mode: te,
                                end: z.end && I(z.end),
                    ...
                    function ie(O, q) {
                        return function (z, X, ke) {
                            ...
                            if (z.indent == null || z.local || (q.dontIndentStates && _(z.state, q.dontIndentStates) > -1)) return C.Pass;
                            ...
                            e: for (;;) {
                                for (var re = 0; re < te.length; re++) {
                                    ...
                                    if (ne.data.dedent && ne.data.dedentIfLineStart !== !1) {
                                        ...
                                        if (se && se[0]) {
                                            (we--, (ne.next || ne.push) && (te = O[ne.next || ne.push]), (X = X.slice(se[0].length)));
                                            continue e;
                                        }
                                    }
                                }
                    ...
                    (C.defineMode("yaml", function () {
                        ...
                        return {
                            token: function (K, $) {
                                var V = K.peek(),
                                    b = $.escaped;
                                if ((($.escaped = !1), V == "#" && (K.pos == 0 || /\s/.test(K.string.charAt(K.pos - 1))))) return (K.skipToEnd(), "comment");
                                if (K.match(/^('([^']|\\.)*'?|"([^"]|\\.)*"?)/)) return "string";
                                if ($.literal && K.indentation() > $.keyCol) return (K.skipToEnd(), "string");
                                if (($.literal && ($.literal = !1), K.sol())) {
                                    if ((($.keyCol = 0), ($.pair = !1), ($.pairStart = !1), K.match("---") || K.match("..."))) return "def";
                                    if (K.match(/\s*-\s+/)) return "meta";
                                }
                                if (K.match(/^(\{|\}|\[|\])/))
                                    return (V == "{" ? $.inlinePairs++ : V == "}" ? $.inlinePairs-- : V == "[" ? $.inlineList++ : $.inlineList--, "meta");
                                if ($.inlineList > 0 && !b && V == ",") return (K.next(), "meta");
                                if ($.inlinePairs > 0 && !b && V == ",") return (($.keyCol = 0), ($.pair = !1), ($.pairStart = !1), K.next(), "meta");
                                if ($.pairStart) {
