            ...
            <Dialog open={open} onOpenChange={setOpen}>
                ...
                <DialogContent showCloseButton={false}>
                    <DialogHeader>
                        ...
                        <DialogDescription>Use your own close button anywhere inside the content.</DialogDescription>
                    </DialogHeader>
                ...
                <DialogContent className="sm:max-w-md">
                    ...
                    >
                        <div>
                            ...
                            <input className="mt-1 block w-full rounded border px-3 py-2 text-sm" defaultValue="John Doe" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium">Email</label>
                            <input className="mt-1 block w-full rounded border px-3 py-2 text-sm" defaultValue="john@example.com" />
                        </div>
                        <DialogFooter>
                            <DialogClose asChild>
