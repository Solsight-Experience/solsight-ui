...
import { Search, Mail, Send, DollarSign, Calendar, Clock, User, Lock, Eye, EyeOff } from "lucide-react";
...
const GroupWrapper = ({ children }: { children: React.ReactNode }) => <div className="flex flex-col gap-8 w-full max-w-md">{children}</div>;
    ...
    render: () => (
        <GroupWrapper>
            <InputGroup>
                ...
                <InputGroupInput placeholder="Invalid email" aria-invalid="true" defaultValue="not-an-email" />
            </InputGroup>
        </GroupWrapper>
    )
};
