...
import { Home, Lock, Settings, User, Bell, Mail, Calendar, BarChart, FileText, Zap } from "lucide-react";
...
const TabsWrapper = ({ children }: { children: React.ReactNode }) => <div className="w-full max-w-2xl">{children}</div>;
            ...
            <Tabs defaultValue="home">
                ...
                <TabsContent value="home" className="mt-4">
                    <div className="rounded-lg border bg-card p-6 text-card-foreground">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">This is the home tab content. You can put anything here.</p>
                    </div>
                </TabsContent>
                ...
                <TabsContent value="settings" className="mt-4">
                    <div className="rounded-lg border bg-card p-6 text-card-foreground">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">Configure application settings and behavior.</p>
                    </div>
                </TabsContent>
            </Tabs>
        </TabsWrapper>
                    ...
                    <div className="flex-1">
                        <TabsContent value="overview">
                            <div className="rounded-lg border bg-card p-6">
                                ...
                                <p className="mt-2 text-sm text-muted-foreground">High-level summary of your account and recent activity.</p>
                            </div>
                        </TabsContent>
                        <TabsContent value="activity">
                            <div className="rounded-lg border bg-card p-6">
                                <h3 className="text-lg font-semibold">Recent Activity</h3>
                                <p className="mt-2 text-sm text-muted-foreground">View all recent actions and notifications.</p>
                            </div>
                        </TabsContent>
                        <TabsContent value="reports">
                            <div className="rounded-lg border bg-card p-6">
                                <h3 className="text-lg font-semibold">Analytics & Reports</h3>
                                <p className="mt-2 text-sm text-muted-foreground">Detailed insights and downloadable reports.</p>
                            </div>
                        </TabsContent>
                    </div>
                </div>
            ...
            <Tabs defaultValue="tab1">
                ...
                <TabsContent value="tab1" className="mt-4">
                    <div className="rounded-lg border bg-card p-6">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">Use horizontal scroll when there are many tabs.</p>
                    </div>
                </TabsContent>
            </Tabs>
        </TabsWrapper>
        ...
        <TabsWrapper>
            <Tabs defaultValue="premium">
                <TabsList className="bg-primary/10 p-1">
                    <TabsTrigger value="free" className="data-[state=active]:bg-transparent data-[state=active]:text-muted-foreground">
                        Free
                    </TabsTrigger>
            ...
            <Tabs {...args}>
                ...
                <TabsContent value="tab1" className="mt-4">
                    <div className="rounded-lg border bg-card p-6 text-center">
                        ...
                        <p className="mt-2 text-sm text-muted-foreground">Change orientation, default tab, or add custom classes.</p>
                    </div>
                </TabsContent>
