...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
    return (
        <div
            ...
            role="group"
            className={cn(
                "group/input-group border-default-darker dark:bg-input/30 relative flex w-full items-center rounded-lg border shadow-xs transition-[color,box-shadow] outline-none",
...
function InputGroupInput({ className, ...props }: React.ComponentProps<"input">) {
    return (
        <Input
            ...
            className={cn("flex-1 rounded-none text-default-dark border-0 bg-transparent shadow-none focus-visible:ring-0 dark:bg-transparent", className)}
            {...props}
        />
    );
}
