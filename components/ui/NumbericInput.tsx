...
export const NumbericInput = ({ value, onChange, formatter, ...rest }: NumbericInputProps) => {
    ...
    return <Input type="text" onFocusCapture={handleFocus} value={display} onChange={handleInput} onBlur={handleBlur} {...rest} />;
};
